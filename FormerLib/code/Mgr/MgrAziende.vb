...
Public Class MgrAziende
    ...
    Public Enum IdAziende 'ESPLICITO ENTRAMBI PER CHIAREZZA
        AziendaSnc = 1
        AziendaSrl = 2
    End Enum
    ...
    Public Shared Function GetNomeBanca(IdAzienda As Integer) As String
        Dim ris As String = String.Empty

        If IdAzienda = IdAziende.AziendaSnc Then
            ris = "Banca Cariparma"
        ElseIf IdAzienda = IdAziende.AziendaSrl Then
            ris = "Banca di Credito Cooperativo della Provincia Romana"
        End If
    ...
    Public Shared Function GetIBAN(IdAzienda As Integer) As String
        ...
        If IdAzienda = IdAziende.AziendaSnc Then
            ris = "IT 55 A 06230 05089 000063379643" '"IT08N0881239091000000034090"
        ElseIf IdAzienda = IdAziende.AziendaSrl Then
            ris = "IT 11 H 08787 39091 000000034748" '"IT05Q0881239091000000034748"
        End If
