...
Public MustInherit Class _TipoCarta
	Inherits LUNA.LunaBaseClassEntity
	Implements _ITipoCarta
	...
	Friend Overridable Sub FillFromDataRecord(myRecord As IDataRecord) Implements _ITipoCarta.FillFromDataRecord
	...
	Private Property Manager As LUNA.ILunaBaseClassDAO(Of TipoCarta)
		Get
			If _Mgr Is Nothing Then
				Dim _MgrType As System.Type = LUNA.LunaContext.GetMgrTypeForEntity(Me.GetType)
				If _MgrType Is Nothing Then _MgrType = GetType(TipiCartaDAO)
				_Mgr = Activator.CreateInstance(_MgrType)
			End If
			Return _Mgr
		End Get
		Set(value As LUNA.ILunaBaseClassDAO(Of TipoCarta))
			_Mgr = value
		End Set
	End Property
...
#Region "Database Field Map"
	...
	Public Overridable Property IdTipoCarta() as integer  Implements _ITipoCarta.IdTipoCarta
		Get
			Return _IdTipoCarta
		End Get
	...
	Public Overridable Property Altezza() as integer  Implements _ITipoCarta.Altezza
		Get
			Return _Altezza
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property CostoCartaKg() as decimal  Implements _ITipoCarta.CostoCartaKg
		Get
	...
	Public Overridable Property CostoRiferimento() as decimal  Implements _ITipoCarta.CostoRiferimento
		Get
	...
	Public Overridable Property DescrizioneEstesa() as string  Implements _ITipoCarta.DescrizioneEstesa
		Get
	...
	Public Overridable Property Finitura() as string  Implements _ITipoCarta.Finitura
		Get
			Return _Finitura
		End Get
		Set (byval value as string)
	...
	Public Overridable Property Grammi() as integer  Implements _ITipoCarta.Grammi
		Get
			Return _Grammi
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property HotFolder() as string  Implements _ITipoCarta.HotFolder
		Get
			Return _HotFolder
		End Get
		Set (byval value as string)
	...
	Public Overridable Property ImgRif() as string  Implements _ITipoCarta.ImgRif
		Get
			Return _ImgRif
		End Get
		Set (byval value as string)
	...
	Public Overridable Property Larghezza() as integer  Implements _ITipoCarta.Larghezza
		Get
			Return _Larghezza
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property Sigla() as string  Implements _ITipoCarta.Sigla
		Get
			Return _Sigla
		End Get
		Set (byval value as string)
	...
	Public Overridable Property Spessore() as Single  Implements _ITipoCarta.Spessore
		Get
			Return _Spessore
		End Get
	...
	Public Overridable Property TipoCarta() as integer  Implements _ITipoCarta.TipoCarta
		Get
			Return _TipoCarta
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property TipoCosto() as integer  Implements _ITipoCarta.TipoCosto
		Get
			Return _TipoCosto
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property Tipologia() as string  Implements _ITipoCarta.Tipologia
		Get
			Return _Tipologia
		End Get
		Set (byval value as string)
...
#Region "Method"
	''' <summary>
	'''This method read an TipoCarta from DB.
	''' </summary>
	''' <returns>
	...
	Public Overridable Function Read(Id As Integer) As Integer
		...
		Try
			Using Manager
				Dim int As TipoCarta = Manager.Read(Id)
	...
	''' <summary>
	'''This method save an TipoCarta on DB.
	''' </summary>
	''' <returns>
