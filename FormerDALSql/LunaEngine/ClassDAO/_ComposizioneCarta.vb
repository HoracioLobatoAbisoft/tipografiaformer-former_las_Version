...
Public MustInherit Class _ComposizioneCarta
	Inherits LUNA.LunaBaseClassEntity
	Implements _IComposizioneCarta
	...
	Public Overridable Sub FillFromDataRecord(myRecord As IDataRecord) Implements _IComposizioneCarta.FillFromDataRecord
	...
	Private Property Manager As LUNA.ILunaBaseClassDAO(Of ComposizioneCarta)
		Get
			If _Mgr Is Nothing Then
				Dim _MgrType As System.Type = LUNA.LunaContext.GetMgrTypeForEntity(Me.GetType)
				If _MgrType Is Nothing Then _MgrType = GetType(ComposizioneCartaDAO)
				_Mgr = Activator.CreateInstance(_MgrType)
			End If
			Return _Mgr
		End Get
		Set(value As LUNA.ILunaBaseClassDAO(Of ComposizioneCarta))
			_Mgr = value
		End Set
	End Property
...
#Region "Database Field Map"
	...
	Public Overridable Property IdCartaComposta() as integer  Implements _IComposizioneCarta.IdCartaComposta
		Get
	...
	Public Overridable Property IdCartaPadre() as integer  Implements _IComposizioneCarta.IdCartaPadre
		Get
	...
	Public Overridable Property IdCartaSingola() as integer  Implements _IComposizioneCarta.IdCartaSingola
		Get
	...
	Public Overridable Property NumFogli() as integer  Implements _IComposizioneCarta.NumFogli
		Get
			Return _NumFogli
		End Get
		Set (byval value as integer)
...
#Region "Method"
	''' <summary>
	'''This method read an ComposizioneCarta from DB.
	''' </summary>
	''' <returns>
	...
	Public Overridable Function Read(Id As Integer) As Integer
		...
		Try
			Using Manager
				Dim int As ComposizioneCarta = Manager.Read(Id)
	...
	''' <summary>
	'''This method save an ComposizioneCarta on DB.
	''' </summary>
	''' <returns>
...
Public Interface _IComposizioneCarta
