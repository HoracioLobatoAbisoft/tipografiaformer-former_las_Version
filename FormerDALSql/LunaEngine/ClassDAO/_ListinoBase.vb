...
Public MustInherit Class _ListinoBase
	Inherits LUNA.LunaBaseClassEntity
	Implements _IListinoBase
	...
	Friend Overridable Sub FillFromDataRecord(myRecord As IDataRecord) Implements _IListinoBase.FillFromDataRecord
		...
		if not myRecord("AllowCustomSize") is DBNull.Value then AllowCustomSize = myRecord("AllowCustomSize")
		if not myRecord("AttivaPromoAutomatico") is DBNull.Value then AttivaPromoAutomatico = myRecord("AttivaPromoAutomatico")
		...
		if not myRecord("ConSoggettiDuplicati") is DBNull.Value then ConSoggettiDuplicati = myRecord("ConSoggettiDuplicati")
		if not myRecord("CounterDayPromo") is DBNull.Value then CounterDayPromo = myRecord("CounterDayPromo")
		...
		if not myRecord("IdGruppoLCAppartenenza") is DBNull.Value then IdGruppoLCAppartenenza = myRecord("IdGruppoLCAppartenenza")
		if not myRecord("IdGruppoListiniConsigliati") is DBNull.Value then IdGruppoListiniConsigliati = myRecord("IdGruppoListiniConsigliati")
		if not myRecord("idGruppoLogico") is DBNull.Value then idGruppoLogico = myRecord("idGruppoLogico")
		if not myRecord("IdHotFolderPostRefine") is DBNull.Value then IdHotFolderPostRefine = myRecord("IdHotFolderPostRefine")
		if not myRecord("IdLavTaglioDuplicati") is DBNull.Value then IdLavTaglioDuplicati = myRecord("IdLavTaglioDuplicati")
		if not myRecord("IdLavTaglioSoggetti") is DBNull.Value then IdLavTaglioSoggetti = myRecord("IdLavTaglioSoggetti")
		if not myRecord("IdListinoBaseSource") is DBNull.Value then IdListinoBaseSource = myRecord("IdListinoBaseSource")
		...
		if not myRecord("NoAttachFile") is DBNull.Value then NoAttachFile = myRecord("NoAttachFile")
		...
		if not myRecord("PrefissoVarianti") is DBNull.Value then PrefissoVarianti = myRecord("PrefissoVarianti")
	...
	Private Property Manager As LUNA.ILunaBaseClassDAO(Of ListinoBase)
		Get
			If _Mgr Is Nothing Then
				Dim _MgrType As System.Type = LUNA.LunaContext.GetMgrTypeForEntity(Me.GetType)
				If _MgrType Is Nothing Then _MgrType = GetType(ListinoBaseDAO)
				_Mgr = Activator.CreateInstance(_MgrType)
			End If
			Return _Mgr
		End Get
		Set(value As LUNA.ILunaBaseClassDAO(Of ListinoBase))
			_Mgr = value
		End Set
	End Property
...
#Region "Database Field Map"
	...
	Public Class WhatIsChanged
		...
		Public Shared Property AllowCustomSize As Boolean = LUNA.LunaContext.WriteAllFieldEveryTime 
		Public Shared Property AttivaPromoAutomatico As Boolean = LUNA.LunaContext.WriteAllFieldEveryTime 
		...
		Public Shared Property ConSoggettiDuplicati As Boolean = LUNA.LunaContext.WriteAllFieldEveryTime 
		Public Shared Property CounterDayPromo As Boolean = LUNA.LunaContext.WriteAllFieldEveryTime 
		...
		Public Shared Property IdGruppoLCAppartenenza As Boolean = LUNA.LunaContext.WriteAllFieldEveryTime 
		Public Shared Property IdGruppoListiniConsigliati As Boolean = LUNA.LunaContext.WriteAllFieldEveryTime 
		Public Shared Property idGruppoLogico As Boolean = LUNA.LunaContext.WriteAllFieldEveryTime 
		Public Shared Property IdHotFolderPostRefine As Boolean = LUNA.LunaContext.WriteAllFieldEveryTime 
		Public Shared Property IdLavTaglioDuplicati As Boolean = LUNA.LunaContext.WriteAllFieldEveryTime 
		Public Shared Property IdLavTaglioSoggetti As Boolean = LUNA.LunaContext.WriteAllFieldEveryTime 
		...
		Public Shared Property NoAttachFile As Boolean = LUNA.LunaContext.WriteAllFieldEveryTime 
		...
		Public Shared Property PrefissoVarianti As Boolean = LUNA.LunaContext.WriteAllFieldEveryTime 
	...
	Private Sub ResetIsChanged()
		...
		WhatIsChanged.AllowCustomSize = LUNA.LunaContext.WriteAllFieldEveryTime 
		WhatIsChanged.AttivaPromoAutomatico = LUNA.LunaContext.WriteAllFieldEveryTime 
		...
		WhatIsChanged.ConSoggettiDuplicati = LUNA.LunaContext.WriteAllFieldEveryTime 
		WhatIsChanged.CounterDayPromo = LUNA.LunaContext.WriteAllFieldEveryTime 
		...
		WhatIsChanged.IdGruppoLCAppartenenza = LUNA.LunaContext.WriteAllFieldEveryTime 
		WhatIsChanged.IdGruppoListiniConsigliati = LUNA.LunaContext.WriteAllFieldEveryTime 
		WhatIsChanged.idGruppoLogico = LUNA.LunaContext.WriteAllFieldEveryTime 
		WhatIsChanged.IdHotFolderPostRefine = LUNA.LunaContext.WriteAllFieldEveryTime 
		WhatIsChanged.IdLavTaglioDuplicati = LUNA.LunaContext.WriteAllFieldEveryTime 
		WhatIsChanged.IdLavTaglioSoggetti = LUNA.LunaContext.WriteAllFieldEveryTime 
		...
		WhatIsChanged.NoAttachFile = LUNA.LunaContext.WriteAllFieldEveryTime 
		...
		WhatIsChanged.PrefissoVarianti = LUNA.LunaContext.WriteAllFieldEveryTime 
	...
	Public Overridable Property IdListinoBase() as integer  Implements _IListinoBase.IdListinoBase
		Get
	...
	Public Overridable Property AbilitaQtaIntermedie() as integer  Implements _IListinoBase.AbilitaQtaIntermedie
		Get
	...
	Public Overridable Property AbilitaQtaSottoColonna1() as integer  Implements _IListinoBase.AbilitaQtaSottoColonna1
		Get
	...
	Protected _AllowCustomSize as integer  = 0 
	Public Overridable Property AllowCustomSize() as integer  Implements _IListinoBase.AllowCustomSize
		Get
			Return _AllowCustomSize
		End Get
		Set (byval value as integer)
			If _AllowCustomSize <> value Then
				IsChanged = True
				WhatIsChanged.AllowCustomSize = True
				_AllowCustomSize = value
			End If
		End Set
	End property 

	Protected _AttivaPromoAutomatico as integer  = 0 
	Public Overridable Property AttivaPromoAutomatico() as integer  Implements _IListinoBase.AttivaPromoAutomatico
		Get
			Return _AttivaPromoAutomatico
		End Get
		Set (byval value as integer)
			If _AttivaPromoAutomatico <> value Then
				IsChanged = True
				WhatIsChanged.AttivaPromoAutomatico = True
				_AttivaPromoAutomatico = value
			End If
		End Set
	End property 

	Protected _AvviamStampa as integer  = 0 
	Public Overridable Property AvviamStampa() as integer  Implements _IListinoBase.AvviamStampa
		Get
	...
	Public Overridable Property AvviamStampa2() as integer  Implements _IListinoBase.AvviamStampa2
		Get
	...
	Public Overridable Property CalcolaAncheDaSolo() as integer  Implements _IListinoBase.CalcolaAncheDaSolo
		Get
	...
	Protected _ConSoggettiDuplicati as integer  = 0 
	Public Overridable Property ConSoggettiDuplicati() as integer  Implements _IListinoBase.ConSoggettiDuplicati
		Get
			Return _ConSoggettiDuplicati
		End Get
		Set (byval value as integer)
			If _ConSoggettiDuplicati <> value Then
				IsChanged = True
				WhatIsChanged.ConSoggettiDuplicati = True
				_ConSoggettiDuplicati = value
			End If
		End Set
	End property 

	Protected _CounterDayPromo as integer  = 0 
	Public Overridable Property CounterDayPromo() as integer  Implements _IListinoBase.CounterDayPromo
		Get
			Return _CounterDayPromo
		End Get
		Set (byval value as integer)
			If _CounterDayPromo <> value Then
				IsChanged = True
				WhatIsChanged.CounterDayPromo = True
				_CounterDayPromo = value
			End If
		End Set
	End property 

	Protected _DefaultNFogli as integer  = 0 
	Public Overridable Property DefaultNFogli() as integer  Implements _IListinoBase.DefaultNFogli
		Get
	...
	Public Overridable Property DescrSito() as string  Implements _IListinoBase.DescrSito
		Get
			Return _DescrSito
		End Get
	...
	Public Overridable Property Disattivo() as integer  Implements _IListinoBase.Disattivo
		Get
			Return _Disattivo
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property faccmax() as integer  Implements _IListinoBase.faccmax
		Get
			Return _faccmax
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property faccmin() as integer  Implements _IListinoBase.faccmin
		Get
			Return _faccmin
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property GoogleDescr() as string  Implements _IListinoBase.GoogleDescr
		Get
			Return _GoogleDescr
		End Get
		Set (byval value as string)
	...
	Public Overridable Property GoogleSEO() as string  Implements _IListinoBase.GoogleSEO
		Get
			Return _GoogleSEO
		End Get
		Set (byval value as string)
	...
	Public Overridable Property IdColoreStampa() as integer  Implements _IListinoBase.IdColoreStampa
		Get
	...
	Public Overridable Property IdCurvaAtt() as integer  Implements _IListinoBase.IdCurvaAtt
		Get
			Return _IdCurvaAtt
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property IdCurvaPubbl() as integer  Implements _IListinoBase.IdCurvaPubbl
		Get
	...
	Public Overridable Property IdFormato() as integer  Implements _IListinoBase.IdFormato
		Get
			Return _IdFormato
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property IdFormatoMacchina2() as integer  Implements _IListinoBase.IdFormatoMacchina2
		Get
	...
	Public Overridable Property IdFormProd() as integer  Implements _IListinoBase.IdFormProd
		Get
			Return _IdFormProd
		End Get
		Set (byval value as integer)
	...
	Protected _IdGruppoLCAppartenenza as integer  = 0 
	Public Overridable Property IdGruppoLCAppartenenza() as integer  Implements _IListinoBase.IdGruppoLCAppartenenza
		Get
			Return _IdGruppoLCAppartenenza
		End Get
		Set (byval value as integer)
			If _IdGruppoLCAppartenenza <> value Then
				IsChanged = True
				WhatIsChanged.IdGruppoLCAppartenenza = True
				_IdGruppoLCAppartenenza = value
			End If
		End Set
	End property 

	Protected _IdGruppoListiniConsigliati as integer  = 0 
	Public Overridable Property IdGruppoListiniConsigliati() as integer  Implements _IListinoBase.IdGruppoListiniConsigliati
		Get
			Return _IdGruppoListiniConsigliati
		End Get
		Set (byval value as integer)
			If _IdGruppoListiniConsigliati <> value Then
				IsChanged = True
				WhatIsChanged.IdGruppoListiniConsigliati = True
				_IdGruppoListiniConsigliati = value
			End If
		End Set
	End property 

	Protected _idGruppoLogico as integer  = 0 
	Public Overridable Property idGruppoLogico() as integer  Implements _IListinoBase.idGruppoLogico
		Get
			Return _idGruppoLogico
		End Get
		Set (byval value as integer)
			If _idGruppoLogico <> value Then
				IsChanged = True
				WhatIsChanged.idGruppoLogico = True
				_idGruppoLogico = value
			End If
		End Set
	End property 

	Protected _IdHotFolderPostRefine as integer  = 0 
	Public Overridable Property IdHotFolderPostRefine() as integer  Implements _IListinoBase.IdHotFolderPostRefine
		Get
	...
	Protected _IdLavTaglioDuplicati as integer  = 0 
	Public Overridable Property IdLavTaglioDuplicati() as integer  Implements _IListinoBase.IdLavTaglioDuplicati
		Get
			Return _IdLavTaglioDuplicati
		End Get
		Set (byval value as integer)
			If _IdLavTaglioDuplicati <> value Then
				IsChanged = True
				WhatIsChanged.IdLavTaglioDuplicati = True
				_IdLavTaglioDuplicati = value
			End If
		End Set
	End property 

	Protected _IdLavTaglioSoggetti as integer  = 0 
	Public Overridable Property IdLavTaglioSoggetti() as integer  Implements _IListinoBase.IdLavTaglioSoggetti
		Get
			Return _IdLavTaglioSoggetti
		End Get
		Set (byval value as integer)
			If _IdLavTaglioSoggetti <> value Then
				IsChanged = True
				WhatIsChanged.IdLavTaglioSoggetti = True
				_IdLavTaglioSoggetti = value
			End If
		End Set
	End property 

	Protected _IdListinoBaseSource as integer  = 0 
	Public Overridable Property IdListinoBaseSource() as integer  Implements _IListinoBase.IdListinoBaseSource
		Get
	...
	Public Overridable Property IdMacchinarioProduzione() as integer  Implements _IListinoBase.IdMacchinarioProduzione
		Get
	...
	Public Overridable Property IdMacchinarioProduzione2() as integer  Implements _IListinoBase.IdMacchinarioProduzione2
		Get
	...
	Public Overridable Property IdMacchinarioTaglio() as integer  Implements _IListinoBase.IdMacchinarioTaglio
		Get
	...
	Public Overridable Property IdModelloCubetto() as integer  Implements _IListinoBase.IdModelloCubetto
		Get
	...
	Public Overridable Property IdPrev() as integer  Implements _IListinoBase.IdPrev
		Get
			Return _IdPrev
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property IdTipoCarta() as integer  Implements _IListinoBase.IdTipoCarta
		Get
			Return _IdTipoCarta
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property IdTipoCartaCop() as integer  Implements _IListinoBase.IdTipoCartaCop
		Get
	...
	Public Overridable Property IdTipoCartaDorso() as integer  Implements _IListinoBase.IdTipoCartaDorso
		Get
	...
	Public Overridable Property IdTipoImballo() as integer  Implements _IListinoBase.IdTipoImballo
		Get
	...
	Public Overridable Property imgrif() as string  Implements _IListinoBase.imgrif
		Get
			Return _imgrif
		End Get
		Set (byval value as string)
	...
	Public Overridable Property ImgSito() as string  Implements _IListinoBase.ImgSito
		Get
			Return _ImgSito
		End Get
		Set (byval value as string)
	...
	Public Overridable Property InEvidenza() as integer  Implements _IListinoBase.InEvidenza
		Get
			Return _InEvidenza
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property IsFormerChoice() as integer  Implements _IListinoBase.IsFormerChoice
		Get
	...
	Public Overridable Property LabelWeb() as string  Implements _IListinoBase.LabelWeb
		Get
			Return _LabelWeb
		End Get
		Set (byval value as string)
	...
	Public Overridable Property LargRotolo() as string  Implements _IListinoBase.LargRotolo
		Get
			Return _LargRotolo
		End Get
		Set (byval value as string)
	...
	Public Overridable Property LastUpdate() as integer  Implements _IListinoBase.LastUpdate
		Get
			Return _LastUpdate
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property MinimaleStampa() as integer  Implements _IListinoBase.MinimaleStampa
		Get
	...
	Public Overridable Property MinimaleStampa2() as integer  Implements _IListinoBase.MinimaleStampa2
		Get
	...
	Public Overridable Property MoltiplicatoreQta() as integer  Implements _IListinoBase.MoltiplicatoreQta
		Get
	...
	Public Overridable Property MoltiplicatoreQta0() as integer  Implements _IListinoBase.MoltiplicatoreQta0
		Get
	...
	Public Overridable Property MoltiplicatoreQta2() as integer  Implements _IListinoBase.MoltiplicatoreQta2
		Get
	...
	Public Overridable Property MoltiplicatoreQta3() as integer  Implements _IListinoBase.MoltiplicatoreQta3
		Get
	...
	Public Overridable Property MoltiplicatoreQta4() as integer  Implements _IListinoBase.MoltiplicatoreQta4
		Get
	...
	Public Overridable Property MoltiplicatoreQta5() as integer  Implements _IListinoBase.MoltiplicatoreQta5
		Get
	...
	Public Overridable Property MoltiplicatoreQtaIntermedia() as integer  Implements _IListinoBase.MoltiplicatoreQtaIntermedia
		Get
	...
	Public Overridable Property MostraPrezziTabella() as integer  Implements _IListinoBase.MostraPrezziTabella
		Get
	...
	Public Overridable Property MultiploQta() as integer  Implements _IListinoBase.MultiploQta
		Get
			Return _MultiploQta
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property NascondiOnline() as integer  Implements _IListinoBase.NascondiOnline
		Get
	...
	Protected _NoAttachFile as integer  = 0 
	Public Overridable Property NoAttachFile() as integer  Implements _IListinoBase.NoAttachFile
		Get
			Return _NoAttachFile
		End Get
		Set (byval value as integer)
			If _NoAttachFile <> value Then
				IsChanged = True
				WhatIsChanged.NoAttachFile = True
				_NoAttachFile = value
			End If
		End Set
	End property 
	...
	Public Overridable Property nofaccsuimpianti() as Boolean  Implements _IListinoBase.nofaccsuimpianti
		Get
	...
	Public Overridable Property Nome() as string  Implements _IListinoBase.Nome
		Get
			Return _Nome
		End Get
		Set (byval value as string)
	...
	Public Overridable Property NomeInterno() as string  Implements _IListinoBase.NomeInterno
		Get
			Return _NomeInterno
		End Get
		Set (byval value as string)
	...
	Public Overridable Property noResa() as integer  Implements _IListinoBase.noResa
		Get
			Return _noResa
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property Ordinamento() as integer  Implements _IListinoBase.Ordinamento
		Get
			Return _Ordinamento
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property p1() as Single  Implements _IListinoBase.p1
		Get
			Return _p1
		End Get
	...
	Public Overridable Property p2() as Single  Implements _IListinoBase.p2
		Get
			Return _p2
		End Get
		Set (byval value as Single)
	...
	Public Overridable Property p3() as Single  Implements _IListinoBase.p3
		Get
			Return _p3
		End Get
		Set (byval value as Single)
	...
	Public Overridable Property p4() as Single  Implements _IListinoBase.p4
		Get
			Return _p4
		End Get
		Set (byval value as Single)
	...
	Public Overridable Property p5() as Single  Implements _IListinoBase.p5
		Get
			Return _p5
		End Get
		Set (byval value as Single)
	...
	Public Overridable Property p6() as Single  Implements _IListinoBase.p6
		Get
			Return _p6
		End Get
		Set (byval value as Single)
	...
	Public Overridable Property PercAdatCostoCopia() as integer  Implements _IListinoBase.PercAdatCostoCopia
		Get
	...
	Public Overridable Property PercMaxPromoFatturato() as integer  Implements _IListinoBase.PercMaxPromoFatturato
		Get
	...
	Public Overridable Property PercPromoAutomatico() as integer  Implements _IListinoBase.PercPromoAutomatico
		Get
	...
	Protected _PrefissoVarianti as string  = "" 
	Public Overridable Property PrefissoVarianti() as string  Implements _IListinoBase.PrefissoVarianti
		Get
			Return _PrefissoVarianti
		End Get
		Set (byval value as string)
			If _PrefissoVarianti <> value Then
				IsChanged = True
				WhatIsChanged.PrefissoVarianti = True
				_PrefissoVarianti = value
			End If
		End Set
	End property 

	Protected _PrendiIcoDa as integer  = 0 
	Public Overridable Property PrendiIcoDa() as integer  Implements _IListinoBase.PrendiIcoDa
		Get
			Return _PrendiIcoDa
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property qta1() as Single  Implements _IListinoBase.qta1
		Get
			Return _qta1
		End Get
		Set (byval value as Single)
	...
	Public Overridable Property qta2() as Single  Implements _IListinoBase.qta2
		Get
			Return _qta2
		End Get
		Set (byval value as Single)
	...
	Public Overridable Property qta3() as Single  Implements _IListinoBase.qta3
		Get
			Return _qta3
		End Get
		Set (byval value as Single)
	...
	Public Overridable Property qta4() as Single  Implements _IListinoBase.qta4
		Get
			Return _qta4
		End Get
		Set (byval value as Single)
	...
	Public Overridable Property qta5() as Single  Implements _IListinoBase.qta5
		Get
			Return _qta5
		End Get
		Set (byval value as Single)
	...
	Public Overridable Property qta6() as Single  Implements _IListinoBase.qta6
		Get
			Return _qta6
		End Get
		Set (byval value as Single)
	...
	Public Overridable Property qtacollo() as integer  Implements _IListinoBase.qtacollo
		Get
			Return _qtacollo
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property QtaDefault() as integer  Implements _IListinoBase.QtaDefault
		Get
			Return _QtaDefault
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property TipoControlloPrezzo() as integer  Implements _IListinoBase.TipoControlloPrezzo
		Get
	...
	Public Overridable Property TipoPrezzo() as integer  Implements _IListinoBase.TipoPrezzo
		Get
			Return _TipoPrezzo
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property v1() as decimal  Implements _IListinoBase.v1
		Get
			Return _v1
		End Get
	...
	Public Overridable Property v2() as decimal  Implements _IListinoBase.v2
		Get
			Return _v2
		End Get
		Set (byval value as decimal)
	...
	Public Overridable Property v3() as decimal  Implements _IListinoBase.v3
		Get
			Return _v3
		End Get
		Set (byval value as decimal)
	...
	Public Overridable Property v4() as decimal  Implements _IListinoBase.v4
		Get
			Return _v4
		End Get
		Set (byval value as decimal)
	...
	Public Overridable Property v5() as decimal  Implements _IListinoBase.v5
		Get
			Return _v5
		End Get
		Set (byval value as decimal)
	...
	Public Overridable Property v6() as decimal  Implements _IListinoBase.v6
		Get
			Return _v6
		End Get
		Set (byval value as decimal)
	...
	Public Overridable Property VMotoreCalcolo() as integer  Implements _IListinoBase.VMotoreCalcolo
		Get
...
#Region "Method"
	''' <summary>
	'''This method read an ListinoBase from DB.
	''' </summary>
	''' <returns>
	...
	Public Overridable Function Read(Id As Integer) As Integer
		...
		Try
			Using Manager
				Dim int As ListinoBase = Manager.Read(Id)
				...
				_AllowCustomSize = int.AllowCustomSize
				_AttivaPromoAutomatico = int.AttivaPromoAutomatico
				_AvviamStampa = int.AvviamStampa
				_AvviamStampa2 = int.AvviamStampa2
				_CalcolaAncheDaSolo = int.CalcolaAncheDaSolo
				_ConSoggettiDuplicati = int.ConSoggettiDuplicati
				_CounterDayPromo = int.CounterDayPromo
				...
				_IdGruppoLCAppartenenza = int.IdGruppoLCAppartenenza
				_IdGruppoListiniConsigliati = int.IdGruppoListiniConsigliati
				_idGruppoLogico = int.idGruppoLogico
				_IdHotFolderPostRefine = int.IdHotFolderPostRefine
				_IdLavTaglioDuplicati = int.IdLavTaglioDuplicati
				_IdLavTaglioSoggetti = int.IdLavTaglioSoggetti
				...
				_NoAttachFile = int.NoAttachFile
				...
				_PrefissoVarianti = int.PrefissoVarianti
	...
	''' <summary>
	'''This method save an ListinoBase on DB.
	''' </summary>
	''' <returns>
	...
	Protected Function InternalIsValid() As Boolean
		...
		if _PrefissoVarianti.Length > 50 then Ris = False
...
Public Interface _IListinoBase
...
#Region "Database Field Map"
	...
	Property AllowCustomSize() as integer
	Property AttivaPromoAutomatico() as integer
	...
	Property CounterDayPromo() as integer
	...
	Property IdGruppoLCAppartenenza() as integer
	Property IdGruppoListiniConsigliati() as integer
	Property idGruppoLogico() as integer
	Property IdHotFolderPostRefine() as integer
	Property IdLavTaglioDuplicati() as integer
	Property IdLavTaglioSoggetti() as integer
	...
	Property NoAttachFile() as integer
	...
	Property PrefissoVarianti() as string
...
Partial Public Class LFM
	...
	Public Class ListinoBase
		...
		Public Shared ReadOnly Property AllowCustomSize As New LUNA.LunaFieldName("AllowCustomSize")
		Public Shared ReadOnly Property AttivaPromoAutomatico As New LUNA.LunaFieldName("AttivaPromoAutomatico")
		...
		Public Shared ReadOnly Property ConSoggettiDuplicati As New LUNA.LunaFieldName("ConSoggettiDuplicati")
		Public Shared ReadOnly Property CounterDayPromo As New LUNA.LunaFieldName("CounterDayPromo")
		...
		Public Shared ReadOnly Property IdGruppoLCAppartenenza As New LUNA.LunaFieldName("IdGruppoLCAppartenenza")
		Public Shared ReadOnly Property IdGruppoListiniConsigliati As New LUNA.LunaFieldName("IdGruppoListiniConsigliati")
		Public Shared ReadOnly Property idGruppoLogico As New LUNA.LunaFieldName("idGruppoLogico")
		Public Shared ReadOnly Property IdHotFolderPostRefine As New LUNA.LunaFieldName("IdHotFolderPostRefine")
		Public Shared ReadOnly Property IdLavTaglioDuplicati As New LUNA.LunaFieldName("IdLavTaglioDuplicati")
		Public Shared ReadOnly Property IdLavTaglioSoggetti As New LUNA.LunaFieldName("IdLavTaglioSoggetti")
		...
		Public Shared ReadOnly Property NoAttachFile As New LUNA.LunaFieldName("NoAttachFile")
		...
		Public Shared ReadOnly Property PrefissoVarianti As New LUNA.LunaFieldName("PrefissoVarianti")
