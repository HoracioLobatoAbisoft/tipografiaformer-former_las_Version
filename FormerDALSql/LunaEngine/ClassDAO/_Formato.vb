...
Public MustInherit Class _Formato
	Inherits LUNA.LunaBaseClassEntity
	Implements _IFormato
	...
	Public Overridable Sub FillFromDataRecord(myRecord As IDataRecord) Implements _IFormato.FillFromDataRecord
	...
	Private Property Manager As LUNA.ILunaBaseClassDAO(Of Formato)
		Get
			If _Mgr Is Nothing Then
				Dim _MgrType As System.Type = LUNA.LunaContext.GetMgrTypeForEntity(Me.GetType)
				If _MgrType Is Nothing Then _MgrType = GetType(FormatiDAO)
				_Mgr = Activator.CreateInstance(_MgrType)
			End If
			Return _Mgr
		End Get
		Set(value As LUNA.ILunaBaseClassDAO(Of Formato))
			_Mgr = value
		End Set
	End Property
...
#Region "Database Field Map"
	...
	Public Overridable Property IdFormato() as integer  Implements _IFormato.IdFormato
		Get
			Return _IdFormato
		End Get
	...
	Public Overridable Property Altezza() as integer  Implements _IFormato.Altezza
		Get
			Return _Altezza
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property CostoLastra() as decimal  Implements _IFormato.CostoLastra
		Get
			Return _CostoLastra
		End Get
	...
	Public Overridable Property DivisioneFoglio() as integer  Implements _IFormato.DivisioneFoglio
		Get
	...
	Public Overridable Property Formato() as string  Implements _IFormato.Formato
		Get
			Return _Formato
		End Get
	...
	Public Overridable Property IdMacchinario() as integer  Implements _IFormato.IdMacchinario
		Get
	...
	Public Overridable Property ImgRif() as string  Implements _IFormato.ImgRif
		Get
			Return _ImgRif
		End Get
		Set (byval value as string)
	...
	Public Overridable Property Larghezza() as integer  Implements _IFormato.Larghezza
		Get
			Return _Larghezza
		End Get
		Set (byval value as integer)
...
#Region "Method"
	''' <summary>
	'''This method read an Formato from DB.
	''' </summary>
	''' <returns>
	...
	Public Overridable Function Read(Id As Integer) As Integer
		...
		Try
			Using Manager
				Dim int As Formato = Manager.Read(Id)
	...
	''' <summary>
	'''This method save an Formato on DB.
	''' </summary>
	''' <returns>
