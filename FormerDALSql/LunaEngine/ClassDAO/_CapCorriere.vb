...
Public MustInherit Class _CapCorriere
	Inherits LUNA.LunaBaseClassEntity
	Implements _ICapCorriere
	...
	Public Overridable Sub FillFromDataRecord(myRecord As IDataRecord) Implements _ICapCorriere.FillFromDataRecord
	...
	Private Property Manager As LUNA.ILunaBaseClassDAO(Of CapCorriere)
		Get
			If _Mgr Is Nothing Then
				Dim _MgrType As System.Type = LUNA.LunaContext.GetMgrTypeForEntity(Me.GetType)
				If _MgrType Is Nothing Then _MgrType = GetType(CapCorriereDAO)
				_Mgr = Activator.CreateInstance(_MgrType)
			End If
			Return _Mgr
		End Get
		Set(value As LUNA.ILunaBaseClassDAO(Of CapCorriere))
			_Mgr = value
		End Set
	End Property
...
#Region "Database Field Map"
	...
	Public Overridable Property IdCapCorr() as integer  Implements _ICapCorriere.IdCapCorr
		Get
			Return _IdCapCorr
		End Get
	...
	Public Overridable Property Cap() as string  Implements _ICapCorriere.Cap
		Get
			Return _Cap
		End Get
	...
	Public Overridable Property IdCorriere() as integer  Implements _ICapCorriere.IdCorriere
		Get
			Return _IdCorriere
		End Get
		Set (byval value as integer)
...
#Region "Method"
	''' <summary>
	'''This method read an CapCorriere from DB.
	''' </summary>
	''' <returns>
	...
	Public Overridable Function Read(Id As Integer) As Integer
		...
		Try
			Using Manager
				Dim int As CapCorriere = Manager.Read(Id)
	...
	''' <summary>
	'''This method save an CapCorriere on DB.
	''' </summary>
	''' <returns>
...
Public Interface _ICapCorriere
