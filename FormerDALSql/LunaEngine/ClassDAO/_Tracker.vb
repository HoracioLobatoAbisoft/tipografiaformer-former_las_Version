...
Public MustInherit Class _Tracker
	Inherits LUNA.LunaBaseClassEntity
	Implements _ITracker
	...
	Friend Overridable Sub FillFromDataRecord(myRecord As IDataRecord) Implements _ITracker.FillFromDataRecord
	...
	Private Property Manager As LUNA.ILunaBaseClassDAO(Of Tracker)
		Get
			If _Mgr Is Nothing Then
				Dim _MgrType As System.Type = LUNA.LunaContext.GetMgrTypeForEntity(Me.GetType)
				If _MgrType Is Nothing Then _MgrType = GetType(TrackerDAO)
				_Mgr = Activator.CreateInstance(_MgrType)
			End If
			Return _Mgr
		End Get
		Set(value As LUNA.ILunaBaseClassDAO(Of Tracker))
			_Mgr = value
		End Set
	End Property
...
#Region "Database Field Map"
	...
	Public Overridable Property IdTrack() as integer  Implements _ITracker.IdTrack
		Get
			Return _IdTrack
		End Get
	...
	Public Overridable Property IdListinoBase() as integer  Implements _ITracker.IdListinoBase
		Get
	...
	Public Overridable Property IdUt() as integer  Implements _ITracker.IdUt
		Get
			Return _IdUt
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property Quando() as DateTime  Implements _ITracker.Quando
		Get
			Return _Quando
		End Get
...
#Region "Method"
	''' <summary>
	'''This method read an Tracker from DB.
	''' </summary>
	''' <returns>
	...
	Public Overridable Function Read(Id As Integer) As Integer
		...
		Try
			Using Manager
				Dim int As Tracker = Manager.Read(Id)
	...
	''' <summary>
	'''This method save an Tracker on DB.
	''' </summary>
	''' <returns>
