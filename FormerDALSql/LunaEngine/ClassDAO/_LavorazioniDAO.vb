...
''' <summary>
'''This class manage persistency on db of Lavorazione object
''' </summary>
''' <remarks>
'''
''' </remarks>

Public MustInherit Class _LavorazioniDAO
	Inherits LUNA.LunaBaseClassDAO(Of Lavorazione)
	...
	''' </summary>
	''' <returns>
	'''Return a Lavorazione object
	''' </returns>
	Public Overrides Function Read(Id as integer) as Lavorazione
		Dim cls as new Lavorazione
	...
	''' </returns>
	Public Overrides Function Save(byRef cls as Lavorazione) as Integer
	...
	''' </summary>
	Public Overrides Sub Delete(byref obj as Lavorazione, Optional ByRef ListaObj as List (of Lavorazione) = Nothing)
		DestroyPermanently (obj.IdLavoro)
		If Not ListaObj Is Nothing Then ListaObj.Remove(obj)
 
	End Sub

	Private Function InternalFind(ByVal OrderBy As String, ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) As Lavorazione
		Dim ris As Lavorazione = Nothing
		Dim So As New LUNA.LunaSearchOption With {.Top = 1, .OrderBy = OrderBy}
		Dim l As IEnumerable(Of Lavorazione) = FindReal(So, Parameter)
		If l.Count Then
			ris = l(0)
		End If
		Return ris
	...
	''' </summary>
	''' <returns>
	'''Return first of Lavorazione
	''' </returns>
	Public Overrides Function Find(ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) As Lavorazione
	...
	Public Overloads Function Find(ByVal OrderBy As String, ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) As Lavorazione
		Return InternalFind(OrderBy, Parameter)
	End Function
		
	''' <summary>
	'''Find one on DB table Lavorazione
	''' </summary>
	''' <returns>
	'''Return first of Lavorazione
	''' </returns>
	Public Overloads Function Find(ByVal OrderBy As LUNA.LunaFieldName, ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) As Lavorazione
	...
	''' </summary>
	''' <returns>
	'''Return a list of Lavorazione
	''' </returns>
	Public Overrides Function FindAll(ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) as IEnumerable(Of Lavorazione)
	...
	''' </returns>
	<Obsolete("Use Instead Constructor with LFM field definition")>
	Public Overloads Function FindAll(ByVal OrderBy As String, ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) as IEnumerable(Of Lavorazione)
	...
	''' </returns>
	<Obsolete("Use Instead Constructor with LFM field definition")>
	Public Overloads Function FindAll(byVal Top as integer, ByVal OrderBy As String, ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) as IEnumerable(Of Lavorazione)
	...
	'''Return a list of Lavorazione
	''' </returns>
	Public Overloads Function FindAll(ByVal OrderBy As Luna.LunaFieldName, ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) as IEnumerable(Of Lavorazione)
	...
	'''Return a list of Lavorazione
	''' </returns>
	Public Overloads Function FindAll(byVal Top as integer, ByVal OrderBy As Luna.LunaFieldName, ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) as IEnumerable(Of Lavorazione)
	...
	'''Return a list of Lavorazione
	''' </returns>
	Public Overloads Function FindAll(ByVal SearchOption As LUNA.LunaSearchOption, ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) As IEnumerable(Of Lavorazione)
	...
	''' </summary>
	''' <returns>
	'''Return a list of Lavorazione by custom query
	''' </returns>
	Public Function GetBySQL(SQlQuery As String, Optional AddEmptyItem As Boolean = False) As IEnumerable(Of Lavorazione)
		Dim Ls As New List(Of Lavorazione)
		Try
	...
	Private Function FindReal(ByVal SearchOption As LUNA.LunaSearchOption, ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) as iEnumerable(Of Lavorazione)
		Dim Ls As New List(Of Lavorazione)
		Try
			Dim sql As String = ""
			sql ="SELECT "   
	...
	''' </summary>
	''' <returns>
	'''Return all record in list of Lavorazione
	''' </returns>
	Public Overloads Function GetAll() As IEnumerable(Of Lavorazione)
	...
	'''Return all record in list of Lavorazione
	''' </returns>
	Public Overloads Function GetAll(Optional OrderByField As LUNA.LunaFieldName = Nothing, Optional ByVal AddEmptyItem As Boolean = False) As IEnumerable(Of Lavorazione)
	...
	''' </returns>
	<Obsolete("Use Instead Constructor with LFM field definition")>
	Public Overrides Function GetAll(Optional OrderByField As String = "",Optional ByVal AddEmptyItem As Boolean = False) As IEnumerable(Of Lavorazione)
		Return InternalGetAll(OrderByField, AddEmptyItem)
	End Function

	Private Function InternalGetAll(Optional OrderByField as string = "", Optional ByVal AddEmptyItem As Boolean = False) as iEnumerable(Of Lavorazione)
		Dim Ls As List(Of Lavorazione)
		Try
			Dim sql As String = ""
	...
	Protected Function GetData(sql as string, Optional ByVal AddEmptyItem As Boolean = False) as iEnumerable(Of Lavorazione)
		Dim Ls As New List(Of Lavorazione)
		Try
			Using myCommand As DbCommand = _Cn.CreateCommand
				myCommand.CommandText = sql
