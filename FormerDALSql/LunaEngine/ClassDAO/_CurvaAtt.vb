...
Public MustInherit Class _CurvaAtt
	Inherits LUNA.LunaBaseClassEntity
	Implements _ICurvaAtt
	...
	Public Overridable Sub FillFromDataRecord(myRecord As IDataRecord) Implements _ICurvaAtt.FillFromDataRecord
	...
	Private Property Manager As LUNA.ILunaBaseClassDAO(Of CurvaAtt)
		Get
			If _Mgr Is Nothing Then
				Dim _MgrType As System.Type = LUNA.LunaContext.GetMgrTypeForEntity(Me.GetType)
				If _MgrType Is Nothing Then _MgrType = GetType(CurvaAttDAO)
				_Mgr = Activator.CreateInstance(_MgrType)
			End If
			Return _Mgr
		End Get
		Set(value As LUNA.ILunaBaseClassDAO(Of CurvaAtt))
			_Mgr = value
		End Set
	End Property
...
#Region "Database Field Map"
	...
	Public Overridable Property IdCurvaAtt() as integer  Implements _ICurvaAtt.IdCurvaAtt
		Get
			Return _IdCurvaAtt
		End Get
	...
	Public Overridable Property NomeCurva() as string  Implements _ICurvaAtt.NomeCurva
		Get
			Return _NomeCurva
		End Get
	...
	Public Overridable Property v1() as Single  Implements _ICurvaAtt.v1
		Get
			Return _v1
		End Get
	...
	Public Overridable Property v2() as Single  Implements _ICurvaAtt.v2
		Get
			Return _v2
		End Get
		Set (byval value as Single)
	...
	Public Overridable Property v3() as Single  Implements _ICurvaAtt.v3
		Get
			Return _v3
		End Get
		Set (byval value as Single)
	...
	Public Overridable Property v4() as Single  Implements _ICurvaAtt.v4
		Get
			Return _v4
		End Get
		Set (byval value as Single)
	...
	Public Overridable Property v5() as Single  Implements _ICurvaAtt.v5
		Get
			Return _v5
		End Get
		Set (byval value as Single)
	...
	Public Overridable Property v6() as Single  Implements _ICurvaAtt.v6
		Get
			Return _v6
		End Get
		Set (byval value as Single)
...
#Region "Method"
	''' <summary>
	'''This method read an CurvaAtt from DB.
	''' </summary>
	''' <returns>
	...
	Public Overridable Function Read(Id As Integer) As Integer
		...
		Try
			Using Manager
				Dim int As CurvaAtt = Manager.Read(Id)
	...
	''' <summary>
	'''This method save an CurvaAtt on DB.
	''' </summary>
	''' <returns>
