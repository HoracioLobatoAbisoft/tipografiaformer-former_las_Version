...
Public MustInherit Class _GruppoVarianteRif
	Inherits LUNA.LunaBaseClassEntity
	Implements _IGruppoVarianteRif
	...
	Friend Overridable Sub FillFromDataRecord(myRecord As IDataRecord) Implements _IGruppoVarianteRif.FillFromDataRecord
	...
	Private Property Manager As LUNA.ILunaBaseClassDAO(Of GruppoVarianteRif)
		Get
			If _Mgr Is Nothing Then
				Dim _MgrType As System.Type = LUNA.LunaContext.GetMgrTypeForEntity(Me.GetType)
				If _MgrType Is Nothing Then _MgrType = GetType(GruppiVariantiRifDAO)
				_Mgr = Activator.CreateInstance(_MgrType)
			End If
			Return _Mgr
		End Get
		Set(value As LUNA.ILunaBaseClassDAO(Of GruppoVarianteRif))
			_Mgr = value
		End Set
	End Property
...
#Region "Database Field Map"
	...
	Public Overridable Property IdGruppoVarianteDett() as integer  Implements _IGruppoVarianteRif.IdGruppoVarianteDett
		Get
	...
	Public Overridable Property IdGruppoVariante() as integer  Implements _IGruppoVarianteRif.IdGruppoVariante
		Get
	...
	Public Overridable Property IdListinoBase() as integer  Implements _IGruppoVarianteRif.IdListinoBase
		Get
	...
	Public Overridable Property IdRiferimento() as integer  Implements _IGruppoVarianteRif.IdRiferimento
		Get
	...
	Public Overridable Property PercDiminuzione() as integer  Implements _IGruppoVarianteRif.PercDiminuzione
		Get
	...
	Public Overridable Property TipoRiferimento() as integer  Implements _IGruppoVarianteRif.TipoRiferimento
		Get
...
#Region "Method"
	''' <summary>
	'''This method read an GruppoVarianteRif from DB.
	''' </summary>
	''' <returns>
	...
	Public Overridable Function Read(Id As Integer) As Integer
		...
		Try
			Using Manager
				Dim int As GruppoVarianteRif = Manager.Read(Id)
	...
	''' <summary>
	'''This method save an GruppoVarianteRif on DB.
	''' </summary>
	''' <returns>
...
Public Interface _IGruppoVarianteRif
