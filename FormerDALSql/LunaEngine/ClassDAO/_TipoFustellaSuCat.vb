...
Public MustInherit Class _TipoFustellaSuCat
	Inherits LUNA.LunaBaseClassEntity
	Implements _ITipoFustellaSuCat
	...
	Public Overridable Sub FillFromDataRecord(myRecord As IDataRecord) Implements _ITipoFustellaSuCat.FillFromDataRecord
	...
	Private Property Manager As LUNA.ILunaBaseClassDAO(Of TipoFustellaSuCat)
		Get
			If _Mgr Is Nothing Then
				Dim _MgrType As System.Type = LUNA.LunaContext.GetMgrTypeForEntity(Me.GetType)
				If _MgrType Is Nothing Then _MgrType = GetType(TipoFustellaSuCatDAO)
				_Mgr = Activator.CreateInstance(_MgrType)
			End If
			Return _Mgr
		End Get
		Set(value As LUNA.ILunaBaseClassDAO(Of TipoFustellaSuCat))
			_Mgr = value
		End Set
	End Property
...
#Region "Database Field Map"
	...
	Public Overridable Property IdCatTipo() as integer  Implements _ITipoFustellaSuCat.IdCatTipo
		Get
			Return _IdCatTipo
		End Get
	...
	Public Overridable Property IdCat() as integer  Implements _ITipoFustellaSuCat.IdCat
		Get
			Return _IdCat
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property IdTipo() as integer  Implements _ITipoFustellaSuCat.IdTipo
		Get
			Return _IdTipo
		End Get
		Set (byval value as integer)
...
#Region "Method"
	''' <summary>
	'''This method read an TipoFustellaSuCat from DB.
	''' </summary>
	''' <returns>
	...
	Public Overridable Function Read(Id As Integer) As Integer
		...
		Try
			Using Manager
				Dim int As TipoFustellaSuCat = Manager.Read(Id)
	...
	''' <summary>
	'''This method save an TipoFustellaSuCat on DB.
	''' </summary>
	''' <returns>
...
Public Interface _ITipoFustellaSuCat
