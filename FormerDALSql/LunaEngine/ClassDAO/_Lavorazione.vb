...
Public MustInherit Class _Lavorazione
	Inherits LUNA.LunaBaseClassEntity
	Implements _ILavorazione
	...
	Friend Overridable Sub FillFromDataRecord(myRecord As IDataRecord) Implements _ILavorazione.FillFromDataRecord
	...
	Private Property Manager As LUNA.ILunaBaseClassDAO(Of Lavorazione)
		Get
			If _Mgr Is Nothing Then
				Dim _MgrType As System.Type = LUNA.LunaContext.GetMgrTypeForEntity(Me.GetType)
				If _MgrType Is Nothing Then _MgrType = GetType(LavorazioniDAO)
				_Mgr = Activator.CreateInstance(_MgrType)
			End If
			Return _Mgr
		End Get
		Set(value As LUNA.ILunaBaseClassDAO(Of Lavorazione))
			_Mgr = value
		End Set
	End Property
...
#Region "Database Field Map"
	...
	Public Overridable Property IdLavoro() as integer  Implements _ILavorazione.IdLavoro
		Get
			Return _IdLavoro
		End Get
	...
	Public Overridable Property Accorpabile() as integer  Implements _ILavorazione.Accorpabile
		Get
			Return _Accorpabile
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property CostoSingCopia() as decimal  Implements _ILavorazione.CostoSingCopia
		Get
	...
	Public Overridable Property Descrizione() as string  Implements _ILavorazione.Descrizione
		Get
			Return _Descrizione
		End Get
	...
	Public Overridable Property DescrizioneEstesa() as string  Implements _ILavorazione.DescrizioneEstesa
		Get
	...
	Public Overridable Property DimensMaxH() as integer  Implements _ILavorazione.DimensMaxH
		Get
			Return _DimensMaxH
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property DimensMaxW() as integer  Implements _ILavorazione.DimensMaxW
		Get
			Return _DimensMaxW
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property DimensMedieMaxH() as integer  Implements _ILavorazione.DimensMedieMaxH
		Get
	...
	Public Overridable Property DimensMedieMaxW() as integer  Implements _ILavorazione.DimensMedieMaxW
		Get
	...
	Public Overridable Property DimensMedieMinH() as integer  Implements _ILavorazione.DimensMedieMinH
		Get
	...
	Public Overridable Property DimensMedieMinW() as integer  Implements _ILavorazione.DimensMedieMinW
		Get
	...
	Public Overridable Property DimensMinH() as integer  Implements _ILavorazione.DimensMinH
		Get
			Return _DimensMinH
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property DimensMinW() as integer  Implements _ILavorazione.DimensMinW
		Get
			Return _DimensMinW
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property ExtraData() as string  Implements _ILavorazione.ExtraData
		Get
			Return _ExtraData
		End Get
		Set (byval value as string)
	...
	Public Overridable Property FormatoRiferimento() as string  Implements _ILavorazione.FormatoRiferimento
		Get
	...
	Public Overridable Property ggRealiz() as integer  Implements _ILavorazione.ggRealiz
		Get
			Return _ggRealiz
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property GrammiMax() as integer  Implements _ILavorazione.GrammiMax
		Get
			Return _GrammiMax
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property GrammiMin() as integer  Implements _ILavorazione.GrammiMin
		Get
			Return _GrammiMin
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property IdCatLav() as integer  Implements _ILavorazione.IdCatLav
		Get
			Return _IdCatLav
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property IdMacchinario() as integer  Implements _ILavorazione.IdMacchinario
		Get
	...
	Public Overridable Property IdMacchinario2() as integer  Implements _ILavorazione.IdMacchinario2
		Get
	...
	Public Overridable Property IdTipoLav() as integer  Implements _ILavorazione.IdTipoLav
		Get
			Return _IdTipoLav
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property ImgRif() as string  Implements _ILavorazione.ImgRif
		Get
			Return _ImgRif
		End Get
		Set (byval value as string)
	...
	Public Overridable Property ImgZoom() as string  Implements _ILavorazione.ImgZoom
		Get
			Return _ImgZoom
		End Get
		Set (byval value as string)
	...
	Public Overridable Property LavorazioneInterna() as integer  Implements _ILavorazione.LavorazioneInterna
		Get
	...
	Public Overridable Property Macchinario() as string  Implements _ILavorazione.Macchinario
		Get
			Return _Macchinario
		End Get
		Set (byval value as string)
	...
	Public Overridable Property Premio() as decimal  Implements _ILavorazione.Premio
		Get
			Return _Premio
		End Get
		Set (byval value as decimal)
	...
	Public Overridable Property PreTaglio() as integer  Implements _ILavorazione.PreTaglio
		Get
			Return _PreTaglio
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property Prezzo() as decimal  Implements _ILavorazione.Prezzo
		Get
			Return _Prezzo
		End Get
		Set (byval value as decimal)
	...
	Public Overridable Property Pubblica() as Boolean  Implements _ILavorazione.Pubblica
		Get
			Return _Pubblica
		End Get
	...
	Public Overridable Property SePresenteCalcolaSuSoggetti() as integer  Implements _ILavorazione.SePresenteCalcolaSuSoggetti
		Get
	...
	Public Overridable Property Sigla() as string  Implements _ILavorazione.Sigla
		Get
			Return _Sigla
		End Get
		Set (byval value as string)
	...
	Public Overridable Property Stato() as integer  Implements _ILavorazione.Stato
		Get
			Return _Stato
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property SuCommessa() as Boolean  Implements _ILavorazione.SuCommessa
		Get
			Return _SuCommessa
		End Get
		Set (byval value as Boolean)
	...
	Public Overridable Property SuProdotto() as Boolean  Implements _ILavorazione.SuProdotto
		Get
			Return _SuProdotto
		End Get
		Set (byval value as Boolean)
	...
	Public Overridable Property TempoRif() as integer  Implements _ILavorazione.TempoRif
		Get
			Return _TempoRif
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property TipoControlloWeb() as integer  Implements _ILavorazione.TipoControlloWeb
		Get
...
#Region "Method"
	''' <summary>
	'''This method read an Lavorazione from DB.
	''' </summary>
	''' <returns>
	...
	Public Overridable Function Read(Id As Integer) As Integer
		...
		Try
			Using Manager
				Dim int As Lavorazione = Manager.Read(Id)
	...
	''' <summary>
	'''This method save an Lavorazione on DB.
	''' </summary>
	''' <returns>
...
Public Interface _ILavorazione
