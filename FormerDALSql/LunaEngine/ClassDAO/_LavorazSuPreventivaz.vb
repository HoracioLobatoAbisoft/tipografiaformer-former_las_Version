...
Public MustInherit Class _LavorazSuPreventivaz
	Inherits LUNA.LunaBaseClassEntity
	Implements _ILavorazSuPreventivaz
	...
	Public Overridable Sub FillFromDataRecord(myRecord As IDataRecord) Implements _ILavorazSuPreventivaz.FillFromDataRecord
	...
	Private Property Manager As LUNA.ILunaBaseClassDAO(Of LavorazSuPreventivaz)
		Get
			If _Mgr Is Nothing Then
				Dim _MgrType As System.Type = LUNA.LunaContext.GetMgrTypeForEntity(Me.GetType)
				If _MgrType Is Nothing Then _MgrType = GetType(LavorazSuPreventivazDAO)
				_Mgr = Activator.CreateInstance(_MgrType)
			End If
			Return _Mgr
		End Get
		Set(value As LUNA.ILunaBaseClassDAO(Of LavorazSuPreventivaz))
			_Mgr = value
		End Set
	End Property
...
#Region "Database Field Map"
	...
	Public Overridable Property IdLavPrev() as integer  Implements _ILavorazSuPreventivaz.IdLavPrev
		Get
			Return _IdLavPrev
		End Get
	...
	Public Overridable Property IdLavoro() as integer  Implements _ILavorazSuPreventivaz.IdLavoro
		Get
			Return _IdLavoro
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property IdListinoBase() as integer  Implements _ILavorazSuPreventivaz.IdListinoBase
		Get
	...
	Public Overridable Property Opzione() as integer  Implements _ILavorazSuPreventivaz.Opzione
		Get
			Return _Opzione
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property Ordine() as integer  Implements _ILavorazSuPreventivaz.Ordine
		Get
			Return _Ordine
		End Get
		Set (byval value as integer)
...
#Region "Method"
	''' <summary>
	'''This method read an LavorazSuPreventivaz from DB.
	''' </summary>
	''' <returns>
	...
	Public Overridable Function Read(Id As Integer) As Integer
		...
		Try
			Using Manager
				Dim int As LavorazSuPreventivaz = Manager.Read(Id)
	...
	''' <summary>
	'''This method save an LavorazSuPreventivaz on DB.
	''' </summary>
	''' <returns>
...
Public Interface _ILavorazSuPreventivaz
