...
Public MustInherit Class _Corriere
	Inherits LUNA.LunaBaseClassEntity
	Implements _ICorriere
	...
	Public Overridable Sub FillFromDataRecord(myRecord As IDataRecord) Implements _ICorriere.FillFromDataRecord
		...
		if not myRecord("PrevedeAccorpamento") is DBNull.Value then PrevedeAccorpamento = myRecord("PrevedeAccorpamento")
	...
	Private Property Manager As LUNA.ILunaBaseClassDAO(Of Corriere)
		Get
			If _Mgr Is Nothing Then
				Dim _MgrType As System.Type = LUNA.LunaContext.GetMgrTypeForEntity(Me.GetType)
				If _MgrType Is Nothing Then _MgrType = GetType(CorrieriDAO)
				_Mgr = Activator.CreateInstance(_MgrType)
			End If
			Return _Mgr
		End Get
		Set(value As LUNA.ILunaBaseClassDAO(Of Corriere))
			_Mgr = value
		End Set
	End Property
...
#Region "Database Field Map"
	...
	Public Overridable Property IdCorriere() as integer  Implements _ICorriere.IdCorriere
		Get
			Return _IdCorriere
		End Get
	...
	Public Overridable Property Costo() as decimal  Implements _ICorriere.Costo
		Get
			Return _Costo
		End Get
	...
	Public Overridable Property Descrizione() as string  Implements _ICorriere.Descrizione
		Get
			Return _Descrizione
		End Get
	...
	Public Overridable Property Disattivo() as integer  Implements _ICorriere.Disattivo
		Get
			Return _Disattivo
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property DisponibileOnline() as Boolean  Implements _ICorriere.DisponibileOnline
		Get
	...
	Public Overridable Property GGConsegna() as integer  Implements _ICorriere.GGConsegna
		Get
			Return _GGConsegna
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property KgLimite1() as integer  Implements _ICorriere.KgLimite1
		Get
			Return _KgLimite1
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property KgLimite2() as integer  Implements _ICorriere.KgLimite2
		Get
			Return _KgLimite2
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property KgLimite3() as integer  Implements _ICorriere.KgLimite3
		Get
			Return _KgLimite3
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property KgLimite4() as integer  Implements _ICorriere.KgLimite4
		Get
			Return _KgLimite4
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property KgLimite5() as integer  Implements _ICorriere.KgLimite5
		Get
			Return _KgLimite5
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property KgLimite6() as integer  Implements _ICorriere.KgLimite6
		Get
			Return _KgLimite6
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property KgLimite7() as integer  Implements _ICorriere.KgLimite7
		Get
			Return _KgLimite7
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property Label() as string  Implements _ICorriere.Label
		Get
			Return _Label
		End Get
		Set (byval value as string)
	...
	Public Overridable Property NomeBreve() as string  Implements _ICorriere.NomeBreve
		Get
			Return _NomeBreve
		End Get
		Set (byval value as string)
	...
	Public Overridable Property PathTrack() as string  Implements _ICorriere.PathTrack
		Get
			Return _PathTrack
		End Get
		Set (byval value as string)
	...
	Public Overridable Property PercPortoAssegnato() as integer  Implements _ICorriere.PercPortoAssegnato
		Get
	...
	Public Overridable Property PrevedeAccorpamento() as Boolean  Implements _ICorriere.PrevedeAccorpamento
		Get
	...
	Public Overridable Property TariffaLimite1() as decimal  Implements _ICorriere.TariffaLimite1
		Get
	...
	Public Overridable Property TariffaLimite2() as decimal  Implements _ICorriere.TariffaLimite2
		Get
	...
	Public Overridable Property TariffaLimite3() as decimal  Implements _ICorriere.TariffaLimite3
		Get
	...
	Public Overridable Property TariffaLimite4() as decimal  Implements _ICorriere.TariffaLimite4
		Get
	...
	Public Overridable Property TariffaLimite5() as decimal  Implements _ICorriere.TariffaLimite5
		Get
	...
	Public Overridable Property TariffaLimite6() as decimal  Implements _ICorriere.TariffaLimite6
		Get
	...
	Public Overridable Property TariffaLimite7() as decimal  Implements _ICorriere.TariffaLimite7
		Get
	...
	Public Overridable Property TestoMail() as string  Implements _ICorriere.TestoMail
		Get
			Return _TestoMail
		End Get
		Set (byval value as string)
	...
	Public Overridable Property TipoCorriere() as integer  Implements _ICorriere.TipoCorriere
		Get
...
#Region "Method"
	''' <summary>
	'''This method read an Corriere from DB.
	''' </summary>
	''' <returns>
	...
	Public Overridable Function Read(Id As Integer) As Integer
		...
		Try
			Using Manager
				Dim int As Corriere = Manager.Read(Id)
	...
	''' <summary>
	'''This method save an Corriere on DB.
	''' </summary>
	''' <returns>
