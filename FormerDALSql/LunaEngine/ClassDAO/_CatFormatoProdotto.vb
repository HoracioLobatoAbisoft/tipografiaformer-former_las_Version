...
Public MustInherit Class _CatFormatoProdotto
	Inherits LUNA.LunaBaseClassEntity
	Implements _ICatFormatoProdotto
	...
	Public Overridable Sub FillFromDataRecord(myRecord As IDataRecord) Implements _ICatFormatoProdotto.FillFromDataRecord
	...
	Private Property Manager As LUNA.ILunaBaseClassDAO(Of CatFormatoProdotto)
		Get
			If _Mgr Is Nothing Then
				Dim _MgrType As System.Type = LUNA.LunaContext.GetMgrTypeForEntity(Me.GetType)
				If _MgrType Is Nothing Then _MgrType = GetType(CatFormatoProdottoDAO)
				_Mgr = Activator.CreateInstance(_MgrType)
			End If
			Return _Mgr
		End Get
		Set(value As LUNA.ILunaBaseClassDAO(Of CatFormatoProdotto))
			_Mgr = value
		End Set
	End Property
...
#Region "Database Field Map"
	...
	Public Overridable Property IdCatFormatoProdotto() as integer  Implements _ICatFormatoProdotto.IdCatFormatoProdotto
		Get
	...
	Public Overridable Property DescrizioneEstesa() as string  Implements _ICatFormatoProdotto.DescrizioneEstesa
		Get
	...
	Public Overridable Property ImgRif() as string  Implements _ICatFormatoProdotto.ImgRif
		Get
			Return _ImgRif
		End Get
		Set (byval value as string)
	...
	Public Overridable Property Nome() as string  Implements _ICatFormatoProdotto.Nome
		Get
			Return _Nome
		End Get
		Set (byval value as string)
...
#Region "Method"
	''' <summary>
	'''This method read an CatFormatoProdotto from DB.
	''' </summary>
	''' <returns>
	...
	Public Overridable Function Read(Id As Integer) As Integer
		...
		Try
			Using Manager
				Dim int As CatFormatoProdotto = Manager.Read(Id)
	...
	''' <summary>
	'''This method save an CatFormatoProdotto on DB.
	''' </summary>
	''' <returns>
...
Public Interface _ICatFormatoProdotto
