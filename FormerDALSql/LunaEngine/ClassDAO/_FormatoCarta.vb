...
Public MustInherit Class _FormatoCarta
	Inherits LUNA.LunaBaseClassEntity
	Implements _IFormatoCarta
	...
	Public Overridable Sub FillFromDataRecord(myRecord As IDataRecord) Implements _IFormatoCarta.FillFromDataRecord
	...
	Private Property Manager As LUNA.ILunaBaseClassDAO(Of FormatoCarta)
		Get
			If _Mgr Is Nothing Then
				Dim _MgrType As System.Type = LUNA.LunaContext.GetMgrTypeForEntity(Me.GetType)
				If _MgrType Is Nothing Then _MgrType = GetType(FormatiCartaDAO)
				_Mgr = Activator.CreateInstance(_MgrType)
			End If
			Return _Mgr
		End Get
		Set(value As LUNA.ILunaBaseClassDAO(Of FormatoCarta))
			_Mgr = value
		End Set
	End Property
...
#Region "Database Field Map"
	...
	Public Overridable Property IdFormCarta() as integer  Implements _IFormatoCarta.IdFormCarta
		Get
			Return _IdFormCarta
		End Get
	...
	Public Overridable Property Altezza() as Single  Implements _IFormatoCarta.Altezza
		Get
			Return _Altezza
		End Get
	...
	Public Overridable Property FormatoCarta() as string  Implements _IFormatoCarta.FormatoCarta
		Get
	...
	Public Overridable Property Larghezza() as Single  Implements _IFormatoCarta.Larghezza
		Get
			Return _Larghezza
		End Get
		Set (byval value as Single)
	...
	Public Overridable Property TolleranzaDifetto() as integer  Implements _IFormatoCarta.TolleranzaDifetto
		Get
	...
	Public Overridable Property TolleranzaEccesso() as integer  Implements _IFormatoCarta.TolleranzaEccesso
		Get
...
#Region "Method"
	''' <summary>
	'''This method read an FormatoCarta from DB.
	''' </summary>
	''' <returns>
	...
	Public Overridable Function Read(Id As Integer) As Integer
		...
		Try
			Using Manager
				Dim int As FormatoCarta = Manager.Read(Id)
	...
	''' <summary>
	'''This method save an FormatoCarta on DB.
	''' </summary>
	''' <returns>
...
Public Interface _IFormatoCarta
