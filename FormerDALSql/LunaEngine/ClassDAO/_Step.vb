...
Public MustInherit Class _Step
...
Public Overridable Sub FillFromDataRecord(myRecord As IDataRecord) Implements _IStep.FillFromDataRecord
...
End Sub
    ...
    Private Property Manager As LUNA.ILunaBaseClassDAO(Of [Step])
        Get
            If _Mgr Is Nothing Then
                Dim _MgrType As System.Type = LUNA.LunaContext.GetMgrTypeForEntity(Me.GetType)
                If _MgrType Is Nothing Then _MgrType = GetType(StepDAO)
                _Mgr = Activator.CreateInstance(_MgrType)
            End If
            Return _Mgr
        End Get
        Set(value As LUNA.ILunaBaseClassDAO(Of [Step]))
            _Mgr = value
        End Set
    End Property
...
Public Overridable Property IdStep() as integer  Implements _IStep.IdStep
    Get
	    Return _IdStep
    End Get
...
Public Overridable Property IdProcedura() as integer  Implements _IStep.IdProcedura
    Get
	    Return _IdProcedura
    End Get
    Set (byval value as integer)
...
Public Overridable Property Titolo() as string  Implements _IStep.Titolo
    Get
	    Return _Titolo
    End Get
...
Public Overridable Property Testo() as string  Implements _IStep.Testo
    Get
	    Return _Testo
    End Get
    Set (byval value as string)
...
Public Overridable Property FilePath() as string  Implements _IStep.FilePath
    Get
	    Return _FilePath
    End Get
    Set (byval value as string)
...
Public Overridable Property Ordine() as integer  Implements _IStep.Ordine
    Get
	    Return _Ordine
    End Get
    Set (byval value as integer)
...
#Region "Method"
''' <summary>
'''This method read an Step from DB.
''' </summary>
''' <returns>
...
Public Overridable Function Read(Id As Integer) As Integer
    ...
    Try
	    Using Manager
	        Dim int As Step = Manager.Read(Id)
                    _IdStep = int.IdStep
...
''' <summary>
'''This method save an Step on DB.
''' </summary>
''' <returns>
