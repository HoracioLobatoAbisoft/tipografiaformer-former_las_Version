...
Public Class CatLav
    Inherits _CatLav
    Implements ICatLav, ICategoriaLavB
...
#Region "Logic Field"
    ...
    Public ReadOnly Property Riassunto As String
        Get
            ...
            If RepartoAppartenenza Then

                ris = FormerLib.FormerEnum.FormerEnumHelper.RepartoStr(RepartoAppartenenza) & " - "
...
#Region "Method"
    ...
    Public Overrides Function Read(Id As Integer) As Integer Implements ICatLav.Read
        Dim Ris As Integer = MyBase.Read(Id)
        Return Ris
    End Function

    Public Overrides Function Save() As Integer Implements ICatLav.Save
