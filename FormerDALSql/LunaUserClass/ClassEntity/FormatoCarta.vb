...
Public Class FormatoCarta
    Inherits _FormatoCarta
    Implements IFormatoCarta
...
#Region "Logic Field"
    ...
    Public ReadOnly Property AltezzaMM As Single
        Get
            Return Altezza * 10
        End Get
    End Property

    Public ReadOnly Property LarghezzaMM As Single
        Get
            Return Larghezza * 10
        End Get
    End Property
...
#Region "Method"
    ...
    Public Overrides Function IsValid() As Boolean Implements IFormatoCarta.IsValid
    ...
    Public Overrides Function Read(Id As Integer) As Integer Implements IFormatoCarta.Read
        Dim Ris As Integer = MyBase.Read(Id)
        Return Ris
    End Function

    Public Overrides Function Save() As Integer Implements IFormatoCarta.Save
...
Public Interface IFormatoCarta
    Inherits _IFormatoCarta
