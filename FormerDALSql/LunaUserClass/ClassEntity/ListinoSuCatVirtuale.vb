...
Public Class ListinoSuCatVirtuale
	Inherits _ListinoSuCatVirtuale
    Implements IListinoSuCatVirtuale
...
Public Overrides Function IsValid() As Boolean Implements IListinoSuCatVirtuale.IsValid
...
Public Overrides Function Read(Id As Integer) As Integer Implements IListinoSuCatVirtuale.Read
	Dim Ris as integer = MyBase.Read(Id)
    Return Ris
End Function

Public Overrides Function Save() As Integer Implements IListinoSuCatVirtuale.Save
...
Public Interface IListinoSuCatVirtuale
        Inherits _IListinoSuCatVirtuale
