...
Class DirectoryTreeView
    ...
    Public Sub New()
        ...
        With Me.ImageList.Images
            ...
            .Add(My.Resources.DESKTOP_FOLDER)
        End With

        ' Construct tree.
        If System.ComponentModel.LicenseManager.UsageMode <> ComponentModel.LicenseUsageMode.Designtime Then RefreshTree()
    End Sub

    Public WriteOnly Property InitialPath As String
        Set(value As String)
            'qui seleziono il path dall'albero

            For Each Node As TreeNode In Nodes
                If value.ToUpper.StartsWith(Node.Text.ToUpper) Then
    ...
    Sub AddDirectories(ByVal tn As TreeNode,
        ...
        If strPath.StartsWith("Desktop") Then
            strPath = strPath.Replace("Desktop", Environment.GetFolderPath(Environment.SpecialFolder.Desktop))
        End If
        ...
        For Each di In adiDirectories
            ...
            tn.Nodes.Add(tnDir)
            If tnDir.FullPath.Replace("\\", "\").ToUpper = InitialPath.ToUpper Then
                SelectedNode = tnDir
                'qui carico i file 
    ...
    Public Sub RefreshTree()
        ...
        Dim DesktopNode As New TreeNode("Desktop", 3, 3)

        Nodes.Add(DesktopNode)
        AddDirectories(DesktopNode)
