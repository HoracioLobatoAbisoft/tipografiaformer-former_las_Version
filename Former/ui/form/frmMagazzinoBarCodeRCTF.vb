...
Friend Class frmMagazzinoBarCodeRCTF
    ...
    Friend Function Carica(Optional Msg As String = "",
                           ...
                           Optional IdCons As Integer = 0,
                           Optional ByVal MsgSupplement As String = "",
                           Optional ByVal WithChiudiERiapri As Boolean = False) As String
        ...
        If WithChiudiERiapri Then
            btnChiudiRiapri.Enabled = True
        Else
            btnChiudiRiapri.Visible = False
        End If
    ...
    Private Sub btnOk_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOk.Click
        ...
        If Codice.Length = 13 Or (Codice.Length = 12 And Codice.StartsWith("8") = True) Then
    ...
    Private Sub btnChiudiRiapri_Click(sender As Object, e As EventArgs) Handles btnChiudiRiapri.Click

        'If MessageBox.Show("Confermi la chiusura della scatola corrente e la creazione di una nuova scatola?", "Crea nuova scatola", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then

        _Ris = FormerConst.Barcode.BarcodeChiudiScatolaERiapri
        Close()
