...
Friend Class frmCodTrackGls
    ...
    Private Sub btnOk_Click(sender As Object, e As EventArgs) Handles btnOk.Click
        ...
        If ModuloValido() Then
            If MessageBox.Show("Confermi il salvataggio del codice di tracking?", "Gestionale Former", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                Using mgr As New ConsegneProgrammateDAO
                    ...
                    If txtCodTrack.Text.Trim.Length <> 0 Then
                        If txtCodTrack.Text.Trim.Length = 16 Then
                            CodTrack = txtCodTrack.Text.Trim.Substring(2, 9)
                        ElseIf txtCodTrack.Text.Trim.Length = 9 Then
                            CodTrack = txtCodTrack.Text.Trim
                        End If
                    End If
            ...
            End If
        Else
            MessageBox.Show("Il Numero Spedizione di GLS deve essere di 9 o 16 caratteri!")
        End If
    End Sub
    ...
    Private Function ModuloValido() As Boolean
        ...
        If txtCodTrack.Text.Trim.Length <> 0 And txtCodTrack.Text.Length <> 9 And txtCodTrack.Text.Length <> 16 Then
            ris = False
        End If
    ...
    Private Sub frmBarCode_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
        ...
        If rdoBarCode.Checked Then
            ...
            If e.KeyChar = Microsoft.VisualBasic.ChrW(Keys.Return) Then
                ...
                If _BufferCodice.Length = 16 Then
                    _BufferCodice = _BufferCodice.Substring(2, 9)
                    Using mgr As New ConsegneProgrammateDAO
                    ...
                    End Using
                Else
                    MessageBox.Show("Il Numero Spedizione di GLS deve essere di 16 caratteri!")
                    _BufferCodice = ""
                End If
