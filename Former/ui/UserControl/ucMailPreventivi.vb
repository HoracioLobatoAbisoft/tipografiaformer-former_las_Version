...
Public Class ucMailPreventivi
    ...
    Public Function CounterDaLavorare() As Integer
        ...
        Using mgr As New PreventiviMailDAO
            ...
            Dim l As List(Of PreventivoMail) = mgr.FindAll(New LUNA.LunaSearchParameter(LFM.PreventivoMail.Stato, enStatoPreventivoMail.DaLavorare),
                                                           New LUNA.LunaSearchParameter(LFM.PreventivoMail.IdMailRif, 0),
                                                           New LUNA.LunaSearchParameter(LFM.PreventivoMail.TipoMail, enTipoMail.Preventivo))
            ris = l.Count
        End Using
    ...
    Private WithEvents F As frmPreventivoMail = Nothing
    ...
    Private Sub Rispondi()
        ...
        Else
            ...
            Else
                ' If mailMsg.IdMailRif Then
                'selNode = selNode.Parent
                'mailMsg = selNode.Tag
                'End If

                If mailMsg.Letto = enSiNo.No Then
                    mailMsg.Letto = enSiNo.Si
                    mailMsg.Save()
                    selNode.NodeFont = New Font(selNode.NodeFont, FontStyle.Regular)
                End If

                'ParentFormEx.Sottofondo()

                F = New frmPreventivoMail
                F.CaricaEx(mailMsg)

                AddHandler F.FormClosed, AddressOf ChiusaFormDettaglioMail

                'Using f As New frmPreventivoMail
                '    If f.Carica(mailMsg) Then
                '        CaricaDati()
                '    End If
                'End Using
    ...
    Private Sub lnkRispondi_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles lnkRispondi.LinkClicked
        ...
        If e.Button = MouseButtons.Right Then
            ...
            If Not node Is Nothing Then
                ...
                If node.Name.StartsWith("M") Then
                    ...
                    If M.Stato = enStatoPreventivoMail.DaLavorare Then
                        SegnaComeLavorataToolStripMenuItem.Enabled = True
                        SegnaDaLavorareToolStripMenu.Enabled = False
                    ElseIf M.Stato = enStatoPreventivoMail.Lavorata Then
                        SegnaComeLavorataToolStripMenuItem.Enabled = False
                        SegnaDaLavorareToolStripMenu.Enabled = True
                    End If
    ...
    Private Sub SegnaDaLeggereToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SegnaDaLeggereToolStripMenuItem.Click
    ...
    Private Sub ToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles SegnaDaLavorareToolStripMenu.Click
    ...
    Private Sub ToolStripMenuItem1_Click_2(sender As Object, e As EventArgs) Handles SegnaComeLettaToolstripmenu.Click
    ...
    Private Sub tlCreaOrdine_Click(sender As Object, e As EventArgs) Handles tlCreaOrdine.Click
        MessageBox.Show("Funzione ancora non disponibile")
        'CreaOrdine()
    End Sub
    ...
    Private Sub txtCercaCli_Click(sender As Object, e As EventArgs) Handles txtCercaCli.Click
