...
Namespace My.Templates
    ...
    Partial Public Class FogliWizard
        ...
        Public Overridable Function TransformText() As String
            ...
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerWeb\code\template\template\FogliWizard.tt",7)
if IsConsigliato then 
            ...
            #End ExternalSource
            Me.Write(" "">"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"<a href=""/")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerWeb\code\template\template\FogliWizard.tt",8)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(IdPrev))
            
            #End ExternalSource
            Me.Write("/")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerWeb\code\template\template\FogliWizard.tt",8)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(IdFormatoProdotto))
            
            #End ExternalSource
            Me.Write("/")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerWeb\code\template\template\FogliWizard.tt",8)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(IdTipoCarta))
            
            #End ExternalSource
            Me.Write("/")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerWeb\code\template\template\FogliWizard.tt",8)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(IdColoriStampa))
            
            #End ExternalSource
            Me.Write("/")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerWeb\code\template\template\FogliWizard.tt",8)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(nfogli))
            
            #End ExternalSource
            Me.Write("/")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerWeb\code\template\template\FogliWizard.tt",8)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(urlPrecedente))
            
            #End ExternalSource
            Me.Write("-")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerWeb\code\template\template\FogliWizard.tt",8)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(NomeInUrl))
            
            #End ExternalSource
            Me.Write(""" title=""")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerWeb\code\template\template\FogliWizard.tt",8)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(descrizione))
            
            #End ExternalSource
            Me.Write(""">"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"<img src=""")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerWeb\code\template\template\FogliWizard.tt",9)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(getimgListino))
            
            #End ExternalSource
            Me.Write(""" border=0><br /><h3>")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerWeb\code\template\template\FogliWizard.tt",9)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(descrizione))
            
            #End ExternalSource
            Me.Write("</h3>"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"<h4><!----></h4>"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"</a>"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"</div>")
