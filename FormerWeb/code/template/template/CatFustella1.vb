...
Namespace My.Templates
    ...
    Partial Public Class CatFustella
        Inherits CatFustellaBase
        '''<summary>
        '''Create the template output
        '''</summary>
        Public Overridable Function TransformText() As String
            Me.Write("<div class=""bloccoW hasTooltip"">"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"<a href=""/etichette/")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerWeb\code\template\template\CatFustella.tt",8)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(IdPreventivazione))
            
            #End ExternalSource
            Me.Write("/")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerWeb\code\template\template\CatFustella.tt",8)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(_C.IdCatFustella))
            
            #End ExternalSource
            Me.Write("/inserisci-dimensioni"">"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"<img src=""")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerWeb\code\template\template\CatFustella.tt",9)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(FormerWebApp.PathListinoImg))
            
            #End ExternalSource
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerWeb\code\template\template\CatFustella.tt",9)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(_C.imgRif))
            
            #End ExternalSource
            Me.Write(""" border=0 alt= """)
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerWeb\code\template\template\CatFustella.tt",9)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(_C.Categoria))
            
            #End ExternalSource
            Me.Write(""">"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"</a>"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"</div><div class=""hidden tooltiptext"">"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"<img src=""/img/icoInformation.p"& _ 
                    "ng"" class=""imgSx"" />"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"<h4>")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerWeb\code\template\template\CatFustella.tt",13)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(_C.Categoria))
            
            #End ExternalSource
            Me.Write("</h4>"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10))
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerWeb\code\template\template\CatFustella.tt",14)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(_C.descrizione))
