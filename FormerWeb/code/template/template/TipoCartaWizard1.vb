...
Namespace My.Templates
    ...
    Partial Public Class TipoCartaWizard
        ...
        Public Overridable Function TransformText() As String
            ...
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerWeb\code\template\template\TipoCartaWizard.tt",7)
if IsConsigliato then 
            ...
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerWeb\code\template\template\TipoCartaWizard.tt",8)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(FormerUrlCreator.GetUrl(IdPrev,IdFormatoProdotto,_TC.IdTipoCarta)))
            
            #End ExternalSource
            Me.Write(""" title=""")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerWeb\code\template\template\TipoCartaWizard.tt",8)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(_Tc.Finitura))
            
            #End ExternalSource
            Me.Write(""">"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"<img src=""")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerWeb\code\template\template\TipoCartaWizard.tt",9)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(FormerWebApp.PathListinoImg))
            
            #End ExternalSource
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerWeb\code\template\template\TipoCartaWizard.tt",9)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(_TC.Imgrif))
            ...
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerWeb\code\template\template\TipoCartaWizard.tt",9)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(_TC.Tipologia))
            
            #End ExternalSource
            Me.Write("</h3>"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"<h4>")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerWeb\code\template\template\TipoCartaWizard.tt",10)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(_TC.Grammi))
            
            #End ExternalSource
            Me.Write(" gr; ")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerWeb\code\template\template\TipoCartaWizard.tt",10)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(_TC.Spessore))
            
            #End ExternalSource
            Me.Write(" micron</h4>"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"</a>"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"</div><div class=""hidden tooltiptext"">"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"<img src=""/img/icoInf"& _ 
                    "ormation.png"" class=""imgSx"" />"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"<h4>")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerWeb\code\template\template\TipoCartaWizard.tt",14)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(_TC.Tipologia))
            
            #End ExternalSource
            Me.Write("</h4>"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10))
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerWeb\code\template\template\TipoCartaWizard.tt",15)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(_TC.DescrizioneHtml))
    ...
    '''</summary>
    <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "16.0.0.0")>  _
    Public Class TipoCartaWizardBase
        #Region "Fields"
