...
Namespace My.Templates
    ...
    Partial Public Class BloccoInEvidenza
        Inherits BloccoInEvidenzaBase
        '''<summary>
        '''Create the template output
        '''</summary>
        Public Overridable Function TransformText() As String
            Me.Write("<div class=""BloccoEvidenza hasTooltip"">"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"<a href=""/")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerWeb\code\template\template\BloccoInEvidenza.tt",8)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(_L.Preventivazione.idPrev))
            
            #End ExternalSource
            Me.Write("/")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerWeb\code\template\template\BloccoInEvidenza.tt",8)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(_L.FormatoProdotto.IdFormProd))
            
            #End ExternalSource
            Me.Write("/")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerWeb\code\template\template\BloccoInEvidenza.tt",8)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(_L.TipoCarta.IdTipoCarta))
            
            #End ExternalSource
            Me.Write("/")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerWeb\code\template\template\BloccoInEvidenza.tt",8)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(_L.ColoreStampa.IdColoreStampa))
            
            #End ExternalSource
            Me.Write("/")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerWeb\code\template\template\BloccoInEvidenza.tt",8)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(_l.nomeInUrl))
            
            #End ExternalSource
            Me.Write(""">"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"<img src=""")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerWeb\code\template\template\BloccoInEvidenza.tt",9)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(FormerWebApp.PathListinoImg))
            
            #End ExternalSource
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerWeb\code\template\template\BloccoInEvidenza.tt",9)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(_L.GetImgFormato))
            
            #End ExternalSource
            Me.Write(""" border=0 alt=""")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerWeb\code\template\template\BloccoInEvidenza.tt",9)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(_L.nome))
            ...
            #End ExternalSource
            Me.Write(""&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"</a>"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"</div>"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"<div class=""hidden tooltiptext""><img src=""")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerWeb\code\template\template\BloccoInEvidenza.tt",12)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(FormerWeb.FormerWebApp.PathListinoImg))
            ...
            #End ExternalSource
            Me.Write(""" class=""imgSx"" />"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"    <h4>")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerWeb\code\template\template\BloccoInEvidenza.tt",13)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(_L.Nome))
            
            #End ExternalSource
            Me.Write("</h4>"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"    ")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerWeb\code\template\template\BloccoInEvidenza.tt",14)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(_L.Nome))
    ...
    '''</summary>
    <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "16.0.0.0")>  _
    Public Class BloccoInEvidenzaBase
        #Region "Fields"
