...
<%End if %>
                ...
                <%If UtenteConnesso.UtenteAutorizato Then %>
                    <div class="colonnaProd" style="display:none">
                <%Else%>
...
<%end if%>
                ...
                <div class="Omaggi" style="float: left;width: 560px;margin:10px 0px 30px 10px;">
                 ...
                 <%End If %>
                <%If UtenteConnesso.UtenteAutorizato Then %>
                    <div class="suggestedProduct" id="sugestedProductHidden" style="display:none">
                <%Else%>
                ...
                <%If UtenteConnesso.UtenteAutorizato Then %>
                    <div class="reviewContainer" id="reviewContainerHidden " style="display:none">
                <%Else%>
                ...
                <%If UtenteConnesso.UtenteAutorizato Then %>
                <div class="DescrizioneDinamica" style="display:none">
                <%Else %>
