...
<div class="BoxOrdFooter">
    ...
    <%End If%>
    <a href="/<%=Ordine.IdConsegna%>/dettaglio-ordine" class="pulsanteOperativo"><img src="/img/icoFreccia16.png" /> Vai al Dettaglio Ordine</a>&nbsp;&nbsp;&nbsp;
    <%If Ordine.Modificabile Then%>
        <asp:LinkButton ID="lnkDelOrd" CssClass="pulsanteOperativo" runat="server" OnClientClick = "return confirm('Sicuro di voler eliminare questo Ordine?');"><img src="/img/icoCestino16.png" />Elimina Ordine</asp:LinkButton>
    <%end If%>
