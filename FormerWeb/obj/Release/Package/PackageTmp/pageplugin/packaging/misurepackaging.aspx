<%@ Page Title="" Language="vb" AutoEventWireup="True" MasterPageFile="~/master/home.master" CodeBehind="misurepackaging.aspx.vb" Inherits="FormerWeb.pMisurePackaging" enableEventValidation="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="introP boxNotePlugin">
          <b>INDICAZIONI</b><br />
          <img src="<%=GetImgMisure() %>" class="imgRight "/>
          <img src="<%=FormerWebApp.PathListinoImg%><%=P.Imgrif%>" class="imgRight "/>
        Inserisci le dimensioni di <b>BASE (B), ALTEZZA (A) e PROFONDITA' (P)</b> del formato CHIUSO che desideri realizzare. Guarda la figura accanto per avere un riferimento visivo.<br /><br />
    ...
    <div class="bodyP" >
            ...
            <table >
                <tr>
                    ...
                    <td style="padding-left: 10px;">
                    <b class="orange ">(P)</b> - <b>Profondità</b> (mm)
                    </td>
                    <td>
                        <asp:TextBox AutoPostBack="true" ID="txtProfondita" Font-Size="Large" CssClass="txtMisure" MaxLength="3" Width="50" runat="server"></asp:TextBox>
                    </td>    
                </tr>
            </table>
    ...
    <div class="risP ">
    <h5>Seleziona la fustella tra quelle disponibili o quella creata su misura per te </h5>
    ...
    <asp:linkbutton id="lnkProseguiTop" runat="server" cssclass="pulsante120Green" ><img src="/img/icoCheckBlack.png" /> Seleziona</asp:linkbutton>
      ...
      <asp:RadioButtonList ID="rdoFustelle" runat="server" CssClass="svgFustella" RepeatLayout="Table" RepeatDirection="Horizontal" ></asp:RadioButtonList>
        ...
        <asp:Panel ID="pnlTutteMis" Visible="false" runat="server"><div class="msgPanel">Per continuare devi inserire tutte le misure (Base, Profondità, Altezza)</div></asp:Panel>
