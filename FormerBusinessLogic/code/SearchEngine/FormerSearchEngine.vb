...
Public Class FormerSearchEngine
    ...
    Public Shared Function EncryptRichiesta(InKeywords As String) As String
        ...
        Dim risTemp As String = InKeywords.Replace(" ", "-")

        'qui levo tutti i caratteri speciali e lascio solo lettere e numeri 

        For Each singChar In risTemp
            If Char.IsLetterOrDigit(singChar) OrElse singChar = "-" Then
                ris &= singChar
            End If
        Next
    ...
    Public Shared Function Cerca(KeywordsInserite As String) As IEnumerable(Of IndiceRicerca)
        ...
        'Dim query As IEnumerable(Of IndiceRicerca) = From p In lRis.Take(100)

        'Return query

        'lRis = lRis.Take(100)

        Return lRis.Take(100)
