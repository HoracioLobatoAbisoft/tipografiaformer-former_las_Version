...
Public Class MgrMarketingWeb
    ...
    Public Shared Function CreaNewsletterSuFileHtml(PathHtmlSource As String,
        ...
        Try
            ...
            Header &= "<a href=""http://www.facebook.com/tipografiaformer.it""><img src=""http://www.tipografiaformer.it/img/btnFacebook.png"" style=""padding-right:5px;""></a>"
            Header &= "<a href=""https://twitter.com/FormerOfficial""><img src=""http://www.tipografiaformer.it/img/btnTwitter.png"" style=""padding-right:5px;""></a>"
            Header &= "<a href=""http://www.youtube.com/user/tipografiaformer""><img src=""http://www.tipografiaformer.it/img/btnYoutube.png""></a></td>"
            Header &= "</tr></table><br>"
    ...
    Public Shared Function CreaNewsletterSuListiniBase(ListaOfferte As List(Of ListinoBaseInTemplate),
        ...
        If PathTarget.Length Then
            ...
            For Each L As ListinoBaseInTemplate In ListaOfferte
                ...
                ris = ris.Replace("<##QTA##>", L.Qta & " pezzi")
