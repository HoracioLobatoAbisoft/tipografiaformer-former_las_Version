...
Namespace My.Templates
    ...
    Partial Public Class MailFatturaOnline
        Inherits MailFatturaOnlineBase
        '''<summary>
        '''Create the template output
        '''</summary>
        Public Overridable Function TransformText() As String
            Me.Write(""&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"Gentile <b>")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerDaemon-Server\code\template\MailFatturaOnline.tt",11)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(C.NomeCliente))
            
            #End ExternalSource
            Me.Write("</b>,<br><br>"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"è stata appena emessa una nuova fattura relativa al tuo ordine num"& _ 
                    "ero <b>")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerDaemon-Server\code\template\MailFatturaOnline.tt",12)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(C.IdConsegna))
            
            #End ExternalSource
            Me.Write("</b>.<br>"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"In allegato trovi Copia di Cortesia in formato <b>PDF</b>.<br>"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"Fattur"& _ 
                    "a/Nota di credito elettronica emessa ai sensi dell.Art 1 D.Lgs 127/2015. Il docu"& _ 
                    "mento originale è a disposizione alternativamente presso il codice destinatario "& _ 
                    "(SDI) o indirizzo PEC comunicatoci ovvero nell' area riservata del sito web dell"& _ 
                    "' Agenzia delle Entrate.<br>"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"<br><br>"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"<table style=""padding:10px 20px 10px 20p"& _ 
                    "x;heigth:50px;width:500px;border-radius:5px;background-color:#d6e03d;font-weight"& _ 
                    ":bold;""><tr>"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"<td align=center><img src=""https://www.tipografiaformer.it/img/ico"& _ 
                    "FileTypePdf.png"" width=20> <a href=""")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerDaemon-Server\code\template\MailFatturaOnline.tt",17)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(GetUrlPdf()))
            
            #End ExternalSource
            Me.Write(""" style=""color:#2b2b2b;"">Clicca qui e scarica dal sito la copia di cortesia in fo"& _ 
                    "rmato PDF</a></td>"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"</tr></table>"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"<br><br>"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"<table style=""padding:10px 20px 10p"& _ 
                    "x 20px;heigth:50px;width:500px;border-radius:5px;background-color:#f1f1f1;font-w"& _ 
                    "eight:bold;""><tr>"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"<td align=center><img src=""https://www.tipografiaformer.it/im"& _ 
                    "g/icoCarrello20.png""> <a href=""https://www.tipografiaformer.it/")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerDaemon-Server\code\template\MailFatturaOnline.tt",21)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(C.IdConsegna))
            
            #End ExternalSource
            Me.Write("/dettaglio-ordine"" style=""color:#2b2b2b;"">Clicca qui e vai al dettaglio dell' ord"& _ 
                    "ine online</a></td>"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"</tr></table>"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10))
    ...
    '''</summary>
    <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "16.0.0.0")>  _
    Public Class MailFatturaOnlineBase
        #Region "Fields"
