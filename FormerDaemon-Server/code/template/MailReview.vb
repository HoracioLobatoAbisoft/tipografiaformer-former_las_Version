...
Namespace My.Templates
    ...
    Partial Public Class MailReview
        Inherits MailReviewBase
        '''<summary>
        '''Create the template output
        '''</summary>
        Public Overridable Function TransformText() As String
            Me.Write(""&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"<div style=""line-height:25px;"">"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"<center><h2 style=""color:#2b2b2b;border-radius"& _ 
                    ":5px;padding:5px;background-color:#d6e03d;""><img src=""https://www.tipografiaform"& _ 
                    "er.it/img/icoStarFull.png""><img src=""https://www.tipografiaformer.it/img/icoStar"& _ 
                    "Full.png""><img src=""https://www.tipografiaformer.it/img/icoStarFull.png""><img sr"& _ 
                    "c=""https://www.tipografiaformer.it/img/icoStarFull.png""><img src=""https://www.ti"& _ 
                    "pografiaformer.it/img/icoStarFull.png""> INSERISCI LA TUA RECENSIONE</h2></center"& _ 
                    "><br>"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"Gentile <b>")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerDaemon-Server\code\template\MailReview.tt",13)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(U.RagSocNome))
            
            #End ExternalSource
            Me.Write("</b>,<br>"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"ti ringraziamo per il tuo recente ordine di <b>")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerDaemon-Server\code\template\MailReview.tt",14)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(O.ListinoBase.nome))
            
            #End ExternalSource
            Me.Write("</b>.<br><br>"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"La tua opinione è importante per noi e tramite la tua recensione p"& _ 
                    "otrai aiutarci a migliorare i nostri prodotti.<br>"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"Lasciare una recensione è se"& _ 
                    "mplice, veloce e anonimo. <br><br>"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"<center><a href=""https://www.tipografiafor"& _ 
                    "mer.it/le-tue-recensioni"" style=""text-decoration:none;""><b style=""padding:5px;bo"& _ 
                    "rder:1px solid #aaaaaa;border-radius:3px;background-color:#91b73e;color:black;"">"& _ 
                    "Inserisci la tua Recensione CLICCANDO QUI</b></a></center>"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10))
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerDaemon-Server\code\template\MailReview.tt",20)
 If FormerConst.Coupon.ImportoCouponScontoPerRecensione then 
            
            #End ExternalSource
            Me.Write("<h4>COUPON DI SCONTO OMAGGIO</h4>"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"Per la tua prima recensione di <b>")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerDaemon-Server\code\template\MailReview.tt",22)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(O.ListinoBase.nome))
            
            #End ExternalSource
            Me.Write("</b> riceverai un Coupon di sconto di <b>")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerDaemon-Server\code\template\MailReview.tt",22)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(FormerLib.FormerHelper.Stringhe.FormattaPrezzo(FormerLib.FormerConst.Coupon.ImportoCouponScontoPerRecensione)))
            
            #End ExternalSource
            Me.Write(" €</b>. Il Coupon ti verrà recapitato tramite email <b>DOPO CHE LA RECENSIONE SAR"& _ 
                    "A' STATA APPROVATA E PUBBLICATA</b> e lo troverai nella sezione <b>I tuoi Coupon"& _ 
                    " di Sconto</b><br /><br />"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10))
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerDaemon-Server\code\template\MailReview.tt",23)
 End If 
            
            #End ExternalSource
            Me.Write(""&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"<h3>Grazie per il tuo contributo!</h3>"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"</div>")
