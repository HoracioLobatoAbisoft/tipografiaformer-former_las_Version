...
Namespace My.Templates
    ...
    Partial Public Class MailReminder
        Inherits MailReminderBase
        '''<summary>
        '''Create the template output
        '''</summary>
        Public Overridable Function TransformText() As String
            Me.Write(""&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"<div style=""line-height:25px;"">"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"<center><h3 style=""color:black;border-radius:5"& _ 
                    "px;padding:5px;background-color:#f58220;"">AVVISO: Alcuni dei tuoi ordini non son"& _ 
                    "o completi e saranno cancellati a breve</h3></center><br>"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"Gentile <b>")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerDaemon-Server\code\template\MailReminder.tt",13)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(U.Nominativo))
            
            #End ExternalSource
            Me.Write("</b>,<br>"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"Vorremmo ricordarti che alcuni dei tuoi ordini sono <b style=""padding:"& _ 
                    "3px;border:1px solid #aaaaaa;border-radius:3px;background-color:")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerDaemon-Server\code\template\MailReminder.tt",14)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(FormerColori.GetColoreStatoConsegnaHTML(enStatoConsegna.InAttesaDiPagamento)))
            
            #End ExternalSource
            Me.Write(";"">")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerDaemon-Server\code\template\MailReminder.tt",14)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(FormerEnumHelper.StatoConsegnaString(enStatoConsegna.InAttesaDiPagamento)))
            
            #End ExternalSource
            Me.Write("</b> o <b style=""padding:3px;border:1px solid #aaaaaa;border-radius:3px;backgroun"& _ 
                    "d-color:")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerDaemon-Server\code\template\MailReminder.tt",14)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(FormerColori.GetColoreStatoOrdineHTML(enStatoOrdine.InAttesaAllegati)))
            
            #End ExternalSource
            Me.Write(";"">")
            
            #ExternalSource("C:\Lavoro\Former\Source\main\FormerDaemon-Server\code\template\MailReminder.tt",14)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(FormerEnumHelper.StatoOrdineString(enStatoOrdine.InAttesaAllegati)))
            
            #End ExternalSource
            Me.Write("</b>."&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"A causa dell'elevato volume di traffico che riceve il nostro sito, conserv"& _ 
                    "eremo i tuoi ordini <b>NON completi</b> solo per i 15 giorni successivi al giorn"& _ 
                    "o in cui li hai creati. Una volta scaduti, tali ordini verranno cancellati e non"& _ 
                    " potranno essere recuperati.<br><br>"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"Sarebbe un vero peccato perdere i tuoi p"& _ 
                    "rodotti personalizzati, quindi ti invitiamo a completare subito i tuoi ordini ef"& _ 
                    "fettuando l'accesso al tuo account <a href=""https://www.tipografiaformer.it/logi"& _ 
                    "n""><b style=""padding:3px;border:1px solid #aaaaaa;border-radius:3px;background-c"& _ 
                    "olor:#91b73e;color:black;"">CLICCANDO QUI</b></a>."&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"<h4>Hai delle domande o del"& _ 
                    "le difficolta?</h4>"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"Visita la nostra sezione di <b>Assistenza ai Clienti</b> "& _ 
                    "<a href=""https://www.tipografiaformer.it/assistenza-clienti""><b style=""padding:3"& _ 
                    "px;border:1px solid #aaaaaa;border-radius:3px;background-color:#91b73e;color:bla"& _ 
                    "ck;"">CLICCANDO QUI</b></a><br><br>"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"Leggi la nostra <b>Guida all'Invio di un O"& _ 
                    "rdine</b> <a href=""https://www.tipografiaformer.it/come-effettuare-un-ordine""><b"& _ 
                    " style=""padding:3px;border:1px solid #aaaaaa;border-radius:3px;background-color:"& _ 
                    "#91b73e;color:black;"">CLICCANDO QUI</b></a><br><br>"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"<h3>Grazie per l'interess"& _ 
                    "e mostrato verso i nostri prodotti!</h3>"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"</div>")
