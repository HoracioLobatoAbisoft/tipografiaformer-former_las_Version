...
Public MustInherit Class _ListinoBaseW
	Inherits LUNA.LunaBaseClassEntity
	Implements _IListinoBaseW
	...
	Friend Overridable Sub FillFromDataRecord(myRecord As IDataRecord) Implements _IListinoBaseW.FillFromDataRecord
	...
	Private Property Manager As LUNA.ILunaBaseClassDAO(Of ListinoBaseW)
		Get
			If _Mgr Is Nothing Then
				Dim _MgrType As System.Type = LUNA.LunaContext.GetMgrTypeForEntity(Me.GetType)
				If _MgrType Is Nothing Then _MgrType = GetType(ListinoBaseWDAO)
				_Mgr = Activator.CreateInstance(_MgrType)
			End If
			Return _Mgr
		End Get
		Set(value As LUNA.ILunaBaseClassDAO(Of ListinoBaseW))
			_Mgr = value
		End Set
	End Property
...
#Region "Database Field Map"
	...
	Public Overridable Property IdListinoBase() as integer  Implements _IListinoBaseW.IdListinoBase
		Get
	...
	Public Overridable Property AbilitaQtaIntermedie() as integer  Implements _IListinoBaseW.AbilitaQtaIntermedie
		Get
	...
	Public Overridable Property AbilitaQtaSottoColonna1() as integer  Implements _IListinoBaseW.AbilitaQtaSottoColonna1
		Get
	...
	Public Overridable Property AllowCustomSize() as integer  Implements _IListinoBaseW.AllowCustomSize
		Get
	...
	Public Overridable Property AvviamStampa() as integer  Implements _IListinoBaseW.AvviamStampa
		Get
	...
	Public Overridable Property AvviamStampa2() as integer  Implements _IListinoBaseW.AvviamStampa2
		Get
	...
	Public Overridable Property CalcolaAncheDaSolo() as integer  Implements _IListinoBaseW.CalcolaAncheDaSolo
		Get
	...
	Public Overridable Property ConSoggettiDuplicati() as integer  Implements _IListinoBaseW.ConSoggettiDuplicati
		Get
	...
	Public Overridable Property DefaultNFogli() as integer  Implements _IListinoBaseW.DefaultNFogli
		Get
	...
	Public Overridable Property DescrSito() as string  Implements _IListinoBaseW.DescrSito
		Get
			Return _DescrSito
		End Get
	...
	Public Overridable Property Disattivo() as integer  Implements _IListinoBaseW.Disattivo
		Get
			Return _Disattivo
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property faccmax() as integer  Implements _IListinoBaseW.faccmax
		Get
			Return _faccmax
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property faccmin() as integer  Implements _IListinoBaseW.faccmin
		Get
			Return _faccmin
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property GoogleDescr() as string  Implements _IListinoBaseW.GoogleDescr
		Get
			Return _GoogleDescr
		End Get
		Set (byval value as string)
	...
	Public Overridable Property GoogleSEO() as string  Implements _IListinoBaseW.GoogleSEO
		Get
			Return _GoogleSEO
		End Get
		Set (byval value as string)
	...
	Public Overridable Property IdColoreStampa() as integer  Implements _IListinoBaseW.IdColoreStampa
		Get
	...
	Public Overridable Property IdCurvaAtt() as integer  Implements _IListinoBaseW.IdCurvaAtt
		Get
			Return _IdCurvaAtt
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property IdCurvaPubbl() as integer  Implements _IListinoBaseW.IdCurvaPubbl
		Get
	...
	Public Overridable Property IdFormato() as integer  Implements _IListinoBaseW.IdFormato
		Get
			Return _IdFormato
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property IdFormatoMacchina2() as integer  Implements _IListinoBaseW.IdFormatoMacchina2
		Get
	...
	Public Overridable Property IdFormProd() as integer  Implements _IListinoBaseW.IdFormProd
		Get
			Return _IdFormProd
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property IdGruppoLCAppartenenza() as integer  Implements _IListinoBaseW.IdGruppoLCAppartenenza
		Get
	...
	Public Overridable Property IdGruppoListiniConsigliati() as integer  Implements _IListinoBaseW.IdGruppoListiniConsigliati
		Get
	...
	Public Overridable Property idGruppoLogico() as integer  Implements _IListinoBaseW.idGruppoLogico
		Get
	...
	Public Overridable Property IdHotFolderPostRefine() as integer  Implements _IListinoBaseW.IdHotFolderPostRefine
		Get
	...
	Public Overridable Property IdLavTaglioDuplicati() as integer  Implements _IListinoBaseW.IdLavTaglioDuplicati
		Get
	...
	Public Overridable Property IdLavTaglioSoggetti() as integer  Implements _IListinoBaseW.IdLavTaglioSoggetti
		Get
	...
	Public Overridable Property IdListinoBaseSource() as integer  Implements _IListinoBaseW.IdListinoBaseSource
		Get
	...
	Public Overridable Property IdMacchinarioProduzione() as integer  Implements _IListinoBaseW.IdMacchinarioProduzione
		Get
	...
	Public Overridable Property IdMacchinarioProduzione2() as integer  Implements _IListinoBaseW.IdMacchinarioProduzione2
		Get
	...
	Public Overridable Property IdMacchinarioTaglio() as integer  Implements _IListinoBaseW.IdMacchinarioTaglio
		Get
	...
	Public Overridable Property IdModelloCubetto() as integer  Implements _IListinoBaseW.IdModelloCubetto
		Get
	...
	Public Overridable Property IdPrev() as integer  Implements _IListinoBaseW.IdPrev
		Get
			Return _IdPrev
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property IdTipoCarta() as integer  Implements _IListinoBaseW.IdTipoCarta
		Get
			Return _IdTipoCarta
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property IdTipoCartaCop() as integer  Implements _IListinoBaseW.IdTipoCartaCop
		Get
	...
	Public Overridable Property IdTipoCartaDorso() as integer  Implements _IListinoBaseW.IdTipoCartaDorso
		Get
	...
	Public Overridable Property IdTipoImballo() as integer  Implements _IListinoBaseW.IdTipoImballo
		Get
	...
	Public Overridable Property imgrif() as string  Implements _IListinoBaseW.imgrif
		Get
			Return _imgrif
		End Get
		Set (byval value as string)
	...
	Public Overridable Property ImgSito() as string  Implements _IListinoBaseW.ImgSito
		Get
			Return _ImgSito
		End Get
		Set (byval value as string)
	...
	Public Overridable Property InEvidenza() as integer  Implements _IListinoBaseW.InEvidenza
		Get
			Return _InEvidenza
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property IsFormerChoice() as integer  Implements _IListinoBaseW.IsFormerChoice
		Get
	...
	Public Overridable Property LabelWeb() as string  Implements _IListinoBaseW.LabelWeb
		Get
			Return _LabelWeb
		End Get
		Set (byval value as string)
	...
	Public Overridable Property LargRotolo() as string  Implements _IListinoBaseW.LargRotolo
		Get
			Return _LargRotolo
		End Get
		Set (byval value as string)
	...
	Public Overridable Property LastUpdate() as integer  Implements _IListinoBaseW.LastUpdate
		Get
			Return _LastUpdate
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property MinimaleStampa() as integer  Implements _IListinoBaseW.MinimaleStampa
		Get
	...
	Public Overridable Property MinimaleStampa2() as integer  Implements _IListinoBaseW.MinimaleStampa2
		Get
	...
	Public Overridable Property MoltiplicatoreQta() as integer  Implements _IListinoBaseW.MoltiplicatoreQta
		Get
	...
	Public Overridable Property MoltiplicatoreQta0() as integer  Implements _IListinoBaseW.MoltiplicatoreQta0
		Get
	...
	Public Overridable Property MoltiplicatoreQta2() as integer  Implements _IListinoBaseW.MoltiplicatoreQta2
		Get
	...
	Public Overridable Property MoltiplicatoreQta3() as integer  Implements _IListinoBaseW.MoltiplicatoreQta3
		Get
	...
	Public Overridable Property MoltiplicatoreQta4() as integer  Implements _IListinoBaseW.MoltiplicatoreQta4
		Get
	...
	Public Overridable Property MoltiplicatoreQta5() as integer  Implements _IListinoBaseW.MoltiplicatoreQta5
		Get
	...
	Public Overridable Property MoltiplicatoreQtaIntermedia() as integer  Implements _IListinoBaseW.MoltiplicatoreQtaIntermedia
		Get
	...
	Public Overridable Property MostraPrezziTabella() as integer  Implements _IListinoBaseW.MostraPrezziTabella
		Get
	...
	Public Overridable Property MultiploQta() as integer  Implements _IListinoBaseW.MultiploQta
		Get
			Return _MultiploQta
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property NascondiOnline() as integer  Implements _IListinoBaseW.NascondiOnline
		Get
	...
	Public Overridable Property NoAttachFile() as integer  Implements _IListinoBaseW.NoAttachFile
		Get
	...
	Public Overridable Property nofaccsuimpianti() as Boolean  Implements _IListinoBaseW.nofaccsuimpianti
		Get
	...
	Public Overridable Property Nome() as string  Implements _IListinoBaseW.Nome
		Get
			Return _Nome
		End Get
		Set (byval value as string)
	...
	Public Overridable Property NomeInterno() as string  Implements _IListinoBaseW.NomeInterno
		Get
			Return _NomeInterno
		End Get
		Set (byval value as string)
	...
	Public Overridable Property noResa() as integer  Implements _IListinoBaseW.noResa
		Get
			Return _noResa
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property Ordinamento() as integer  Implements _IListinoBaseW.Ordinamento
		Get
			Return _Ordinamento
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property p1() as Single  Implements _IListinoBaseW.p1
		Get
			Return _p1
		End Get
	...
	Public Overridable Property p2() as Single  Implements _IListinoBaseW.p2
		Get
			Return _p2
		End Get
		Set (byval value as Single)
	...
	Public Overridable Property p3() as Single  Implements _IListinoBaseW.p3
		Get
			Return _p3
		End Get
		Set (byval value as Single)
	...
	Public Overridable Property p4() as Single  Implements _IListinoBaseW.p4
		Get
			Return _p4
		End Get
		Set (byval value as Single)
	...
	Public Overridable Property p5() as Single  Implements _IListinoBaseW.p5
		Get
			Return _p5
		End Get
		Set (byval value as Single)
	...
	Public Overridable Property p6() as Single  Implements _IListinoBaseW.p6
		Get
			Return _p6
		End Get
		Set (byval value as Single)
	...
	Public Overridable Property PercAdatCostoCopia() as integer  Implements _IListinoBaseW.PercAdatCostoCopia
		Get
	...
	Public Overridable Property PercMaxPromoFatturato() as integer  Implements _IListinoBaseW.PercMaxPromoFatturato
		Get
	...
	Public Overridable Property PercPromoAutomatico() as integer  Implements _IListinoBaseW.PercPromoAutomatico
		Get
	...
	Public Overridable Property PrefissoVarianti() as string  Implements _IListinoBaseW.PrefissoVarianti
		Get
	...
	Public Overridable Property PrendiIcoDa() as integer  Implements _IListinoBaseW.PrendiIcoDa
		Get
			Return _PrendiIcoDa
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property qta1() as Single  Implements _IListinoBaseW.qta1
		Get
			Return _qta1
		End Get
		Set (byval value as Single)
	...
	Public Overridable Property qta2() as Single  Implements _IListinoBaseW.qta2
		Get
			Return _qta2
		End Get
		Set (byval value as Single)
	...
	Public Overridable Property qta3() as Single  Implements _IListinoBaseW.qta3
		Get
			Return _qta3
		End Get
		Set (byval value as Single)
	...
	Public Overridable Property qta4() as Single  Implements _IListinoBaseW.qta4
		Get
			Return _qta4
		End Get
		Set (byval value as Single)
	...
	Public Overridable Property qta5() as Single  Implements _IListinoBaseW.qta5
		Get
			Return _qta5
		End Get
		Set (byval value as Single)
	...
	Public Overridable Property qta6() as Single  Implements _IListinoBaseW.qta6
		Get
			Return _qta6
		End Get
		Set (byval value as Single)
	...
	Public Overridable Property qtacollo() as integer  Implements _IListinoBaseW.qtacollo
		Get
			Return _qtacollo
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property QtaDefault() as integer  Implements _IListinoBaseW.QtaDefault
		Get
			Return _QtaDefault
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property TipoControlloPrezzo() as integer  Implements _IListinoBaseW.TipoControlloPrezzo
		Get
	...
	Public Overridable Property TipoPrezzo() as integer  Implements _IListinoBaseW.TipoPrezzo
		Get
			Return _TipoPrezzo
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property v1() as decimal  Implements _IListinoBaseW.v1
		Get
			Return _v1
		End Get
	...
	Public Overridable Property v2() as decimal  Implements _IListinoBaseW.v2
		Get
			Return _v2
		End Get
		Set (byval value as decimal)
	...
	Public Overridable Property v3() as decimal  Implements _IListinoBaseW.v3
		Get
			Return _v3
		End Get
		Set (byval value as decimal)
	...
	Public Overridable Property v4() as decimal  Implements _IListinoBaseW.v4
		Get
			Return _v4
		End Get
		Set (byval value as decimal)
	...
	Public Overridable Property v5() as decimal  Implements _IListinoBaseW.v5
		Get
			Return _v5
		End Get
		Set (byval value as decimal)
	...
	Public Overridable Property v6() as decimal  Implements _IListinoBaseW.v6
		Get
			Return _v6
		End Get
		Set (byval value as decimal)
	...
	Public Overridable Property VMotoreCalcolo() as integer  Implements _IListinoBaseW.VMotoreCalcolo
		Get
...
#Region "Method"
	''' <summary>
	'''This method read an ListinoBaseW from DB.
	''' </summary>
	''' <returns>
	...
	Public Overridable Function Read(Id As Integer) As Integer
		...
		Try
			Using Manager
				Dim int As ListinoBaseW = Manager.Read(Id)
	...
	''' <summary>
	'''This method save an ListinoBaseW on DB.
	''' </summary>
	''' <returns>
...
Public Interface _IListinoBaseW
