...
''' <summary>
'''This class manage persistency on db of PreventivazioneW object
''' </summary>
''' <remarks>
'''
''' </remarks>

Public MustInherit Class _PreventivazioniWDAO
	Inherits LUNA.LunaBaseClassDAO(Of PreventivazioneW)
	...
	''' </summary>
	''' <returns>
	'''Return a PreventivazioneW object
	''' </returns>
	Public Overrides Function Read(Id as integer) as PreventivazioneW
		Dim cls as new PreventivazioneW
	...
	''' </returns>
	Public Overrides Function Save(byRef cls as PreventivazioneW) as Integer
	...
	''' </summary>
	Public Overrides Sub Delete(byref obj as PreventivazioneW, Optional ByRef ListaObj as List (of PreventivazioneW) = Nothing)
		DestroyPermanently (obj.IdPrev)
		If Not ListaObj Is Nothing Then ListaObj.Remove(obj)
 
	End Sub

	Private Function InternalFind(ByVal OrderBy As String, ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) As PreventivazioneW
		Dim ris As PreventivazioneW = Nothing
		Dim So As New LUNA.LunaSearchOption With {.Top = 1, .OrderBy = OrderBy}
		Dim l As IEnumerable(Of PreventivazioneW) = FindReal(So, Parameter)
		If l.Count Then
			ris = l(0)
		End If
		Return ris
	...
	''' </summary>
	''' <returns>
	'''Return first of PreventivazioneW
	''' </returns>
	Public Overrides Function Find(ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) As PreventivazioneW
	...
	Public Overloads Function Find(ByVal OrderBy As String, ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) As PreventivazioneW
		Return InternalFind(OrderBy, Parameter)
	End Function
		
	''' <summary>
	'''Find one on DB table PreventivazioneW
	''' </summary>
	''' <returns>
	'''Return first of PreventivazioneW
	''' </returns>
	Public Overloads Function Find(ByVal OrderBy As LUNA.LunaFieldName, ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) As PreventivazioneW
	...
	''' </summary>
	''' <returns>
	'''Return a list of PreventivazioneW
	''' </returns>
	Public Overrides Function FindAll(ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) as IEnumerable(Of PreventivazioneW)
	...
	''' </returns>
	<Obsolete("Use Instead Constructor with LFM field definition")>
	Public Overloads Function FindAll(ByVal OrderBy As String, ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) as IEnumerable(Of PreventivazioneW)
	...
	''' </returns>
	<Obsolete("Use Instead Constructor with LFM field definition")>
	Public Overloads Function FindAll(byVal Top as integer, ByVal OrderBy As String, ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) as IEnumerable(Of PreventivazioneW)
	...
	'''Return a list of PreventivazioneW
	''' </returns>
	Public Overloads Function FindAll(ByVal OrderBy As Luna.LunaFieldName, ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) as IEnumerable(Of PreventivazioneW)
	...
	'''Return a list of PreventivazioneW
	''' </returns>
	Public Overloads Function FindAll(byVal Top as integer, ByVal OrderBy As Luna.LunaFieldName, ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) as IEnumerable(Of PreventivazioneW)
	...
	'''Return a list of PreventivazioneW
	''' </returns>
	Public Overloads Function FindAll(ByVal SearchOption As LUNA.LunaSearchOption, ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) As IEnumerable(Of PreventivazioneW)
	...
	''' </summary>
	''' <returns>
	'''Return a list of PreventivazioneW by custom query
	''' </returns>
	Public Function GetBySQL(SQlQuery As String, Optional AddEmptyItem As Boolean = False) As IEnumerable(Of PreventivazioneW)
		Dim Ls As New List(Of PreventivazioneW)
		Try
	...
	Private Function FindReal(ByVal SearchOption As LUNA.LunaSearchOption, ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) as iEnumerable(Of PreventivazioneW)
		Dim Ls As New List(Of PreventivazioneW)
		Try
			Dim sql As String = ""
			sql ="SELECT "   
	...
	''' </summary>
	''' <returns>
	'''Return all record in list of PreventivazioneW
	''' </returns>
	Public Overloads Function GetAll() As IEnumerable(Of PreventivazioneW)
	...
	'''Return all record in list of PreventivazioneW
	''' </returns>
	Public Overloads Function GetAll(Optional OrderByField As LUNA.LunaFieldName = Nothing, Optional ByVal AddEmptyItem As Boolean = False) As IEnumerable(Of PreventivazioneW)
	...
	''' </returns>
	<Obsolete("Use Instead Constructor with LFM field definition")>
	Public Overrides Function GetAll(Optional OrderByField As String = "",Optional ByVal AddEmptyItem As Boolean = False) As IEnumerable(Of PreventivazioneW)
		Return InternalGetAll(OrderByField, AddEmptyItem)
	End Function

	Private Function InternalGetAll(Optional OrderByField as string = "", Optional ByVal AddEmptyItem As Boolean = False) as iEnumerable(Of PreventivazioneW)
		Dim Ls As List(Of PreventivazioneW)
		Try
			Dim sql As String = ""
	...
	Protected Function GetData(sql as string, Optional ByVal AddEmptyItem As Boolean = False) as iEnumerable(Of PreventivazioneW)
		Dim Ls As New List(Of PreventivazioneW)
		Try
			Using myCommand As DbCommand = _Cn.CreateCommand
				myCommand.CommandText = sql
