...
Public MustInherit Class _GruppoVarianteW
	Inherits LUNA.LunaBaseClassEntity
	Implements _IGruppoVarianteW
	...
	Friend Overridable Sub FillFromDataRecord(myRecord As IDataRecord) Implements _IGruppoVarianteW.FillFromDataRecord
	...
	Private Property Manager As LUNA.ILunaBaseClassDAO(Of GruppoVarianteW)
		Get
			If _Mgr Is Nothing Then
				Dim _MgrType As System.Type = LUNA.LunaContext.GetMgrTypeForEntity(Me.GetType)
				If _MgrType Is Nothing Then _MgrType = GetType(GruppiVariantiWDAO)
				_Mgr = Activator.CreateInstance(_MgrType)
			End If
			Return _Mgr
		End Get
		Set(value As LUNA.ILunaBaseClassDAO(Of GruppoVarianteW))
			_Mgr = value
		End Set
	End Property
...
#Region "Database Field Map"
	...
	Public Overridable Property IdGruppoVariante() as integer  Implements _IGruppoVarianteW.IdGruppoVariante
		Get
	...
	Public Overridable Property Nome() as string  Implements _IGruppoVarianteW.Nome
		Get
			Return _Nome
		End Get
...
#Region "Method"
	''' <summary>
	'''This method read an GruppoVarianteW from DB.
	''' </summary>
	''' <returns>
	...
	Public Overridable Function Read(Id As Integer) As Integer
		...
		Try
			Using Manager
				Dim int As GruppoVarianteW = Manager.Read(Id)
	...
	''' <summary>
	'''This method save an GruppoVarianteW on DB.
	''' </summary>
	''' <returns>
...
Public Interface _IGruppoVarianteW
