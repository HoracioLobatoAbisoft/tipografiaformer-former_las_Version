...
Public MustInherit Class _ResaW
	...
	Friend Overridable Sub FillFromDataRecord(myRecord As IDataRecord) Implements _IResaW.FillFromDataRecord
	...
	Private Property Manager As LUNA.ILunaBaseClassDAO(Of ResaW)
		Get
			If _Mgr Is Nothing Then
				Dim _MgrType As System.Type = LUNA.LunaContext.GetMgrTypeForEntity(Me.GetType)
				If _MgrType Is Nothing Then _MgrType = GetType(ResaWDAO)
				_Mgr = Activator.CreateInstance(_MgrType)
			End If
			Return _Mgr
		End Get
		Set(value As LUNA.ILunaBaseClassDAO(Of ResaW))
			_Mgr = value
		End Set
	End Property
...
#Region "Database Field Map"
	...
	Public Overridable Property IDFormatoResa() as integer  Implements _IResaW.IDFormatoResa
		Get
	...
	Public Overridable Property IdFormato() as integer  Implements _IResaW.IdFormato
		Get
			Return _IdFormato
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property IdFormCarta() as integer  Implements _IResaW.IdFormCarta
		Get
			Return _IdFormCarta
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property PercScarto() as integer  Implements _IResaW.PercScarto
		Get
			Return _PercScarto
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property Resa() as integer  Implements _IResaW.Resa
		Get
			Return _Resa
		End Get
		Set (byval value as integer)
...
#Region "Method"
	''' <summary>
	'''This method read an ResaW from DB.
	''' </summary>
	''' <returns>
	...
	Public Overridable Function Read(Id As Integer) As Integer
		...
		Try
			Using Manager
				Dim int As ResaW = Manager.Read(Id)
	...
	''' <summary>
	'''This method save an ResaW on DB.
	''' </summary>
	''' <returns>
