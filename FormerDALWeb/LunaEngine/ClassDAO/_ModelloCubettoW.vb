...
Public MustInherit Class _ModelloCubettoW
	Inherits LUNA.LunaBaseClassEntity
	Implements _IModelloCubettoW
	...
	Friend Overridable Sub FillFromDataRecord(myRecord As IDataRecord) Implements _IModelloCubettoW.FillFromDataRecord
	...
	Private Property Manager As LUNA.ILunaBaseClassDAO(Of ModelloCubettoW)
		Get
			If _Mgr Is Nothing Then
				Dim _MgrType As System.Type = LUNA.LunaContext.GetMgrTypeForEntity(Me.GetType)
				If _MgrType Is Nothing Then _MgrType = GetType(ModelliCubettiWDAO)
				_Mgr = Activator.CreateInstance(_MgrType)
			End If
			Return _Mgr
		End Get
		Set(value As LUNA.ILunaBaseClassDAO(Of ModelloCubettoW))
			_Mgr = value
		End Set
	End Property
...
#Region "Database Field Map"
	...
	Public Overridable Property IDModelloCubetto() as integer  Implements _IModelloCubettoW.IDModelloCubetto
		Get
	...
	Public Overridable Property Larghezza() as integer  Implements _IModelloCubettoW.Larghezza
		Get
			Return _Larghezza
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property Lunghezza() as integer  Implements _IModelloCubettoW.Lunghezza
		Get
			Return _Lunghezza
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property Nome() as string  Implements _IModelloCubettoW.Nome
		Get
			Return _Nome
		End Get
	...
	Public Overridable Property Profondita() as integer  Implements _IModelloCubettoW.Profondita
		Get
			Return _Profondita
		End Get
		Set (byval value as integer)
...
#Region "Method"
	''' <summary>
	'''This method read an ModelloCubettoW from DB.
	''' </summary>
	''' <returns>
	...
	Public Overridable Function Read(Id As Integer) As Integer
		...
		Try
			Using Manager
				Dim int As ModelloCubettoW = Manager.Read(Id)
	...
	''' <summary>
	'''This method save an ModelloCubettoW on DB.
	''' </summary>
	''' <returns>
...
Public Interface _IModelloCubettoW
