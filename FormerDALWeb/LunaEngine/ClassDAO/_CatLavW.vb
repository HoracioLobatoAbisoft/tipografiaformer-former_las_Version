...
Public MustInherit Class _CatLavW
	Inherits LUNA.LunaBaseClassEntity
	Implements _ICatLavW
	...
	Friend Overridable Sub FillFromDataRecord(myRecord As IDataRecord) Implements _ICatLavW.FillFromDataRecord
	...
	Private Property Manager As LUNA.ILunaBaseClassDAO(Of CatLavW)
		Get
			If _Mgr Is Nothing Then
				Dim _MgrType As System.Type = LUNA.LunaContext.GetMgrTypeForEntity(Me.GetType)
				If _MgrType Is Nothing Then _MgrType = GetType(CatLavWDAO)
				_Mgr = Activator.CreateInstance(_MgrType)
			End If
			Return _Mgr
		End Get
		Set(value As LUNA.ILunaBaseClassDAO(Of CatLavW))
			_Mgr = value
		End Set
	End Property
...
#Region "Database Field Map"
	...
	Public Overridable Property IdCatLav() as integer  Implements _ICatLavW.IdCatLav
		Get
			Return _IdCatLav
		End Get
	...
	Public Overridable Property Descrizione() as string  Implements _ICatLavW.Descrizione
		Get
			Return _Descrizione
		End Get
	...
	Public Overridable Property FileLavNonSelezionata() as string  Implements _ICatLavW.FileLavNonSelezionata
		Get
	...
	Public Overridable Property OrdineEsecuzione() as integer  Implements _ICatLavW.OrdineEsecuzione
		Get
	...
	Public Overridable Property RepartoAppartenenza() as integer  Implements _ICatLavW.RepartoAppartenenza
		Get
	...
	Public Overridable Property SovrascriviImgScheda() as integer  Implements _ICatLavW.SovrascriviImgScheda
		Get
	...
	Public Overridable Property TipoCaratteristica() as integer  Implements _ICatLavW.TipoCaratteristica
		Get
	...
	Public Overridable Property TipoControllo() as integer  Implements _ICatLavW.TipoControllo
		Get
	...
	Public Overridable Property VisibilePreventivo() as integer  Implements _ICatLavW.VisibilePreventivo
		Get
...
#Region "Method"
	''' <summary>
	'''This method read an CatLavW from DB.
	''' </summary>
	''' <returns>
	...
	Public Overridable Function Read(Id As Integer) As Integer
		...
		Try
			Using Manager
				Dim int As CatLavW = Manager.Read(Id)
	...
	''' <summary>
	'''This method save an CatLavW on DB.
	''' </summary>
	''' <returns>
