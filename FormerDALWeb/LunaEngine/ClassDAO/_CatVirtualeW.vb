...
Public MustInherit Class _CatVirtualeW
	Inherits LUNA.LunaBaseClassEntity
	Implements _ICatVirtualeW
	...
	Friend Overridable Sub FillFromDataRecord(myRecord As IDataRecord) Implements _ICatVirtualeW.FillFromDataRecord
	...
	Private Property Manager As LUNA.ILunaBaseClassDAO(Of CatVirtualeW)
		Get
			If _Mgr Is Nothing Then
				Dim _MgrType As System.Type = LUNA.LunaContext.GetMgrTypeForEntity(Me.GetType)
				If _MgrType Is Nothing Then _MgrType = GetType(CatVirtualiWDAO)
				_Mgr = Activator.CreateInstance(_MgrType)
			End If
			Return _Mgr
		End Get
		Set(value As LUNA.ILunaBaseClassDAO(Of CatVirtualeW))
			_Mgr = value
		End Set
	End Property
...
#Region "Database Field Map"
	...
	Public Overridable Property IdCatVirtuale() as integer  Implements _ICatVirtualeW.IdCatVirtuale
		Get
	...
	Public Overridable Property Nome() as string  Implements _ICatVirtualeW.Nome
		Get
			Return _Nome
		End Get
...
#Region "Method"
	''' <summary>
	'''This method read an CatVirtualeW from DB.
	''' </summary>
	''' <returns>
	...
	Public Overridable Function Read(Id As Integer) As Integer
		...
		Try
			Using Manager
				Dim int As CatVirtualeW = Manager.Read(Id)
	...
	''' <summary>
	'''This method save an CatVirtualeW on DB.
	''' </summary>
	''' <returns>
...
Public Interface _ICatVirtualeW
