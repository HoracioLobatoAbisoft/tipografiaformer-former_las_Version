...
Public MustInherit Class _PrezzoLavoroW
	Inherits LUNA.LunaBaseClassEntity
	Implements _IPrezzoLavoroW
	...
	Friend Overridable Sub FillFromDataRecord(myRecord As IDataRecord) Implements _IPrezzoLavoroW.FillFromDataRecord
	...
	Private Property Manager As LUNA.ILunaBaseClassDAO(Of PrezzoLavoroW)
		Get
			If _Mgr Is Nothing Then
				Dim _MgrType As System.Type = LUNA.LunaContext.GetMgrTypeForEntity(Me.GetType)
				If _MgrType Is Nothing Then _MgrType = GetType(PrezziLavoroWDAO)
				_Mgr = Activator.CreateInstance(_MgrType)
			End If
			Return _Mgr
		End Get
		Set(value As LUNA.ILunaBaseClassDAO(Of PrezzoLavoroW))
			_Mgr = value
		End Set
	End Property
...
#Region "Database Field Map"
	...
	Public Overridable Property IdLavPrezzo() as integer  Implements _IPrezzoLavoroW.IdLavPrezzo
		Get
			Return _IdLavPrezzo
		End Get
	...
	Public Overridable Property IdFormProd() as integer  Implements _IPrezzoLavoroW.IdFormProd
		Get
			Return _IdFormProd
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property IdLavoro() as integer  Implements _IPrezzoLavoroW.IdLavoro
		Get
			Return _IdLavoro
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property Prezzo() as decimal  Implements _IPrezzoLavoroW.Prezzo
		Get
			Return _Prezzo
		End Get
	...
	Public Overridable Property Prezzo2() as decimal  Implements _IPrezzoLavoroW.Prezzo2
		Get
			Return _Prezzo2
		End Get
		Set (byval value as decimal)
	...
	Public Overridable Property PrezzoMin() as decimal  Implements _IPrezzoLavoroW.PrezzoMin
		Get
			Return _PrezzoMin
		End Get
		Set (byval value as decimal)
	...
	Public Overridable Property PrezzoMin2() as decimal  Implements _IPrezzoLavoroW.PrezzoMin2
		Get
			Return _PrezzoMin2
		End Get
		Set (byval value as decimal)
	...
	Public Overridable Property PrezzoOltre() as decimal  Implements _IPrezzoLavoroW.PrezzoOltre
		Get
			Return _PrezzoOltre
		End Get
		Set (byval value as decimal)
	...
	Public Overridable Property PrezzoOltre2() as decimal  Implements _IPrezzoLavoroW.PrezzoOltre2
		Get
	...
	Public Overridable Property QtaRif() as integer  Implements _IPrezzoLavoroW.QtaRif
		Get
			Return _QtaRif
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property TipoGrandezza() as integer  Implements _IPrezzoLavoroW.TipoGrandezza
		Get
...
#Region "Method"
	''' <summary>
	'''This method read an PrezzoLavoroW from DB.
	''' </summary>
	''' <returns>
	...
	Public Overridable Function Read(Id As Integer) As Integer
		...
		Try
			Using Manager
				Dim int As PrezzoLavoroW = Manager.Read(Id)
	...
	''' <summary>
	'''This method save an PrezzoLavoroW on DB.
	''' </summary>
	''' <returns>
...
Public Interface _IPrezzoLavoroW
