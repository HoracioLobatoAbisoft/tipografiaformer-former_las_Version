...
Public MustInherit Class _ColoreRGBW
	Inherits LUNA.LunaBaseClassEntity
	Implements _IColoreRGBW
	...
	Friend Overridable Sub FillFromDataRecord(myRecord As IDataRecord) Implements _IColoreRGBW.FillFromDataRecord
	...
	Private Property Manager As LUNA.ILunaBaseClassDAO(Of ColoreRGBW)
		Get
			If _Mgr Is Nothing Then
				Dim _MgrType As System.Type = LUNA.LunaContext.GetMgrTypeForEntity(Me.GetType)
				If _MgrType Is Nothing Then _MgrType = GetType(ColoriRGBWDAO)
				_Mgr = Activator.CreateInstance(_MgrType)
			End If
			Return _Mgr
		End Get
		Set(value As LUNA.ILunaBaseClassDAO(Of ColoreRGBW))
			_Mgr = value
		End Set
	End Property
...
#Region "Database Field Map"
	...
	Public Overridable Property IdColore() as integer  Implements _IColoreRGBW.IdColore
		Get
			Return _IdColore
		End Get
	...
	Public Overridable Property Alpha() as integer  Implements _IColoreRGBW.Alpha
		Get
			Return _Alpha
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property Attivo() as integer  Implements _IColoreRGBW.Attivo
		Get
			Return _Attivo
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property B() as integer  Implements _IColoreRGBW.B
		Get
			Return _B
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property G() as integer  Implements _IColoreRGBW.G
		Get
			Return _G
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property ImportoMillePunti() as Single  Implements _IColoreRGBW.ImportoMillePunti
		Get
	...
	Public Overridable Property Nome() as string  Implements _IColoreRGBW.Nome
		Get
			Return _Nome
		End Get
	...
	Public Overridable Property R() as integer  Implements _IColoreRGBW.R
		Get
			Return _R
		End Get
		Set (byval value as integer)
...
#Region "Method"
	''' <summary>
	'''This method read an ColoreRGBW from DB.
	''' </summary>
	''' <returns>
	...
	Public Overridable Function Read(Id As Integer) As Integer
		...
		Try
			Using Manager
				Dim int As ColoreRGBW = Manager.Read(Id)
	...
	''' <summary>
	'''This method save an ColoreRGBW on DB.
	''' </summary>
	''' <returns>
