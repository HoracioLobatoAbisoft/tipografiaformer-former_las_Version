...
Public MustInherit Class _OmaggioW
	Inherits LUNA.LunaBaseClassEntity
	Implements _IOmaggioW
	...
	Friend Overridable Sub FillFromDataRecord(myRecord As IDataRecord) Implements _IOmaggioW.FillFromDataRecord
	...
	Private Property Manager As LUNA.ILunaBaseClassDAO(Of OmaggioW)
		Get
			If _Mgr Is Nothing Then
				Dim _MgrType As System.Type = LUNA.LunaContext.GetMgrTypeForEntity(Me.GetType)
				If _MgrType Is Nothing Then _MgrType = GetType(OmaggiWDAO)
				_Mgr = Activator.CreateInstance(_MgrType)
			End If
			Return _Mgr
		End Get
		Set(value As LUNA.ILunaBaseClassDAO(Of OmaggioW))
			_Mgr = value
		End Set
	End Property
...
#Region "Database Field Map"
	...
	Public Overridable Property IdOmaggio() as integer  Implements _IOmaggioW.IdOmaggio
		Get
			Return _IdOmaggio
		End Get
	...
	Public Overridable Property IdListinoOmaggio() as integer  Implements _IOmaggioW.IdListinoOmaggio
		Get
	...
	Public Overridable Property IdPreventivazione() as integer  Implements _IOmaggioW.IdPreventivazione
		Get
	...
	Public Overridable Property ImportoMin() as decimal  Implements _IOmaggioW.ImportoMin
		Get
			Return _ImportoMin
		End Get
	...
	Public Overridable Property QtaOmaggio() as integer  Implements _IOmaggioW.QtaOmaggio
		Get
			Return _QtaOmaggio
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property TipoCliente() as integer  Implements _IOmaggioW.TipoCliente
		Get
			Return _TipoCliente
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property Tipologia() as integer  Implements _IOmaggioW.Tipologia
		Get
			Return _Tipologia
		End Get
		Set (byval value as integer)
...
#Region "Method"
	''' <summary>
	'''This method read an OmaggioW from DB.
	''' </summary>
	''' <returns>
	...
	Public Overridable Function Read(Id As Integer) As Integer
		...
		Try
			Using Manager
				Dim int As OmaggioW = Manager.Read(Id)
	...
	''' <summary>
	'''This method save an OmaggioW on DB.
	''' </summary>
	''' <returns>
