...
Public MustInherit Class _PreventivazioneW
	Inherits LUNA.LunaBaseClassEntity
	Implements _IPreventivazioneW
	...
	Friend Overridable Sub FillFromDataRecord(myRecord As IDataRecord) Implements _IPreventivazioneW.FillFromDataRecord
	...
	Private Property Manager As LUNA.ILunaBaseClassDAO(Of PreventivazioneW)
		Get
			If _Mgr Is Nothing Then
				Dim _MgrType As System.Type = LUNA.LunaContext.GetMgrTypeForEntity(Me.GetType)
				If _MgrType Is Nothing Then _MgrType = GetType(PreventivazioniWDAO)
				_Mgr = Activator.CreateInstance(_MgrType)
			End If
			Return _Mgr
		End Get
		Set(value As LUNA.ILunaBaseClassDAO(Of PreventivazioneW))
			_Mgr = value
		End Set
	End Property
...
#Region "Database Field Map"
	...
	Public Overridable Property IdPrev() as integer  Implements _IPreventivazioneW.IdPrev
		Get
			Return _IdPrev
		End Get
	...
	Public Overridable Property Descrizione() as string  Implements _IPreventivazioneW.Descrizione
		Get
			Return _Descrizione
		End Get
	...
	Public Overridable Property DescrizioneEstesa() as string  Implements _IPreventivazioneW.DescrizioneEstesa
		Get
	...
	Public Overridable Property DispOnline() as Boolean  Implements _IPreventivazioneW.DispOnline
		Get
			Return _DispOnline
		End Get
	...
	Public Overridable Property ggFast() as integer  Implements _IPreventivazioneW.ggFast
		Get
			Return _ggFast
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property ggNorm() as integer  Implements _IPreventivazioneW.ggNorm
		Get
			Return _ggNorm
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property ggSlow() as integer  Implements _IPreventivazioneW.ggSlow
		Get
			Return _ggSlow
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property GoogleDescr() as string  Implements _IPreventivazioneW.GoogleDescr
		Get
			Return _GoogleDescr
		End Get
		Set (byval value as string)
	...
	Public Overridable Property GraficaPerFacciata() as decimal  Implements _IPreventivazioneW.GraficaPerFacciata
		Get
	...
	Public Overridable Property GruppoVariante() as integer  Implements _IPreventivazioneW.GruppoVariante
		Get
	...
	Public Overridable Property IdColoreStampaDefault() as integer  Implements _IPreventivazioneW.IdColoreStampaDefault
		Get
	...
	Public Overridable Property IdFunzionePack() as integer  Implements _IPreventivazioneW.IdFunzionePack
		Get
	...
	Public Overridable Property IdMacchinario() as integer  Implements _IPreventivazioneW.IdMacchinario
		Get
	...
	Public Overridable Property IdMacchinarioTaglio() as integer  Implements _IPreventivazioneW.IdMacchinarioTaglio
		Get
	...
	Public Overridable Property IdPluginToUse() as integer  Implements _IPreventivazioneW.IdPluginToUse
		Get
	...
	Public Overridable Property IdReparto() as integer  Implements _IPreventivazioneW.IdReparto
		Get
			Return _IdReparto
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property ImgRif() as string  Implements _IPreventivazioneW.ImgRif
		Get
			Return _ImgRif
		End Get
		Set (byval value as string)
	...
	Public Overridable Property ImgSito() as string  Implements _IPreventivazioneW.ImgSito
		Get
			Return _ImgSito
		End Get
		Set (byval value as string)
	...
	Public Overridable Property Linguetta() as integer  Implements _IPreventivazioneW.Linguetta
		Get
			Return _Linguetta
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property NascondiAlbero() as integer  Implements _IPreventivazioneW.NascondiAlbero
		Get
	...
	Public Overridable Property PercCoupon() as integer  Implements _IPreventivazioneW.PercCoupon
		Get
			Return _PercCoupon
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property PercFast() as integer  Implements _IPreventivazioneW.PercFast
		Get
			Return _PercFast
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property PercSlow() as integer  Implements _IPreventivazioneW.PercSlow
		Get
			Return _PercSlow
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property Prefisso() as string  Implements _IPreventivazioneW.Prefisso
		Get
			Return _Prefisso
		End Get
		Set (byval value as string)
	...
	Public Overridable Property RicaricoPubblico() as integer  Implements _IPreventivazioneW.RicaricoPubblico
		Get
	...
	Public Overridable Property SaltaCS() as integer  Implements _IPreventivazioneW.SaltaCS
		Get
			Return _SaltaCS
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property SaltaFP() as integer  Implements _IPreventivazioneW.SaltaFP
		Get
			Return _SaltaFP
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property SaltaTC() as integer  Implements _IPreventivazioneW.SaltaTC
		Get
			Return _SaltaTC
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property TipoProd() as integer  Implements _IPreventivazioneW.TipoProd
		Get
			Return _TipoProd
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property UrlVideo() as string  Implements _IPreventivazioneW.UrlVideo
		Get
			Return _UrlVideo
		End Get
		Set (byval value as string)
...
#Region "Method"
	''' <summary>
	'''This method read an PreventivazioneW from DB.
	''' </summary>
	''' <returns>
	...
	Public Overridable Function Read(Id As Integer) As Integer
		...
		Try
			Using Manager
				Dim int As PreventivazioneW = Manager.Read(Id)
				_IdPrev = int.IdPrev
	...
	''' <summary>
	'''This method save an PreventivazioneW on DB.
	''' </summary>
	''' <returns>
...
Public Interface _IPreventivazioneW
