...
Public MustInherit Class _CouponW
	Inherits LUNA.LunaBaseClassEntity
	Implements _ICouponW
	...
	Friend Overridable Sub FillFromDataRecord(myRecord As IDataRecord) Implements _ICouponW.FillFromDataRecord
		...
		if not myRecord("IdCouponInt") is DBNull.Value then IdCouponInt = myRecord("IdCouponInt")
	...
	Private Property Manager As LUNA.ILunaBaseClassDAO(Of CouponW)
		Get
			If _Mgr Is Nothing Then
				Dim _MgrType As System.Type = LUNA.LunaContext.GetMgrTypeForEntity(Me.GetType)
				If _MgrType Is Nothing Then _MgrType = GetType(CouponWDAO)
				_Mgr = Activator.CreateInstance(_MgrType)
			End If
			Return _Mgr
		End Get
		Set(value As LUNA.ILunaBaseClassDAO(Of CouponW))
			_Mgr = value
		End Set
	End Property
...
#Region "Database Field Map"
	...
	Public Class WhatIsChanged
		...
		Public Shared Property IdCouponInt As Boolean = LUNA.LunaContext.WriteAllFieldEveryTime 
	...
	Private Sub ResetIsChanged()
		...
		WhatIsChanged.IdCouponInt = LUNA.LunaContext.WriteAllFieldEveryTime 
	...
	Public Overridable Property IdCoupon() as integer  Implements _ICouponW.IdCoupon
		Get
			Return _IdCoupon
		End Get
	...
	Public Overridable Property Codice() as string  Implements _ICouponW.Codice
		Get
			Return _Codice
		End Get
	...
	Public Overridable Property DataFineValidita() as DateTime  Implements _ICouponW.DataFineValidita
		Get
	...
	Public Overridable Property DataInizioValidita() as DateTime  Implements _ICouponW.DataInizioValidita
		Get
	...
	Protected _IdCouponInt as integer  = 0 
	Public Overridable Property IdCouponInt() as integer  Implements _ICouponW.IdCouponInt
		Get
			Return _IdCouponInt
		End Get
		Set (byval value as integer)
			If _IdCouponInt <> value Then
				IsChanged = True
				WhatIsChanged.IdCouponInt = True
				_IdCouponInt = value
			End If
		End Set
	End property 
	...
	Public Overridable Property IdLavoro() as integer  Implements _ICouponW.IdLavoro
		Get
			Return _IdLavoro
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property IdListinoBase() as integer  Implements _ICouponW.IdListinoBase
		Get
	...
	Public Overridable Property IdReview() as integer  Implements _ICouponW.IdReview
		Get
			Return _IdReview
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property ImgOnline() as string  Implements _ICouponW.ImgOnline
		Get
			Return _ImgOnline
		End Get
		Set (byval value as string)
	...
	Public Overridable Property ImportoFisso() as decimal  Implements _ICouponW.ImportoFisso
		Get
	...
	Public Overridable Property ImportoMinimoSpesa() as decimal  Implements _ICouponW.ImportoMinimoSpesa
		Get
	...
	Public Overridable Property MaxVolte() as integer  Implements _ICouponW.MaxVolte
		Get
			Return _MaxVolte
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property Nome() as string  Implements _ICouponW.Nome
		Get
			Return _Nome
		End Get
		Set (byval value as string)
	...
	Public Overridable Property Percentuale() as integer  Implements _ICouponW.Percentuale
		Get
			Return _Percentuale
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property QtaSpecifica() as integer  Implements _ICouponW.QtaSpecifica
		Get
	...
	Public Overridable Property Riservato() as integer  Implements _ICouponW.Riservato
		Get
			Return _Riservato
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property RiservatoATipoUtente() as integer  Implements _ICouponW.RiservatoATipoUtente
		Get
	...
	Public Overridable Property Stato() as integer  Implements _ICouponW.Stato
		Get
			Return _Stato
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property UrlHref() as string  Implements _ICouponW.UrlHref
		Get
			Return _UrlHref
		End Get
		Set (byval value as string)
	...
	Public Overridable Property VisibileOnline() as integer  Implements _ICouponW.VisibileOnline
		Get
...
#Region "Method"
	''' <summary>
	'''This method read an CouponW from DB.
	''' </summary>
	''' <returns>
	...
	''' <summary>
	'''This method save an CouponW on DB.
	''' </summary>
	''' <returns>
...
#Region "Database Field Map"
	...
	Property IdCouponInt() as integer
...
Partial Public Class LFM
	...
	Public Class CouponW
		...
		Public Shared ReadOnly Property IdCouponInt As New LUNA.LunaFieldName("IdCouponInt")
