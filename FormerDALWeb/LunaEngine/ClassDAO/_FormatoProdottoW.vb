...
Public MustInherit Class _FormatoProdottoW
	Inherits LUNA.LunaBaseClassEntity
	Implements _IFormatoProdottoW
	...
	Friend Overridable Sub FillFromDataRecord(myRecord As IDataRecord) Implements _IFormatoProdottoW.FillFromDataRecord
	...
	Private Property Manager As LUNA.ILunaBaseClassDAO(Of FormatoProdottoW)
		Get
			If _Mgr Is Nothing Then
				Dim _MgrType As System.Type = LUNA.LunaContext.GetMgrTypeForEntity(Me.GetType)
				If _MgrType Is Nothing Then _MgrType = GetType(FormatiProdottoWDAO)
				_Mgr = Activator.CreateInstance(_MgrType)
			End If
			Return _Mgr
		End Get
		Set(value As LUNA.ILunaBaseClassDAO(Of FormatoProdottoW))
			_Mgr = value
		End Set
	End Property
...
#Region "Database Field Map"
	...
	Public Overridable Property IdFormProd() as integer  Implements _IFormatoProdottoW.IdFormProd
		Get
			Return _IdFormProd
		End Get
	...
	Public Overridable Property DescrizioneEstesa() as string  Implements _IFormatoProdottoW.DescrizioneEstesa
		Get
	...
	Public Overridable Property Formato() as string  Implements _IFormatoProdottoW.Formato
		Get
			Return _Formato
		End Get
		Set (byval value as string)
	...
	Public Overridable Property IdCatFormatoProdotto() as integer  Implements _IFormatoProdottoW.IdCatFormatoProdotto
		Get
	...
	Public Overridable Property IdFormCarta() as integer  Implements _IFormatoProdottoW.IdFormCarta
		Get
			Return _IdFormCarta
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property ImgRif() as string  Implements _IFormatoProdottoW.ImgRif
		Get
			Return _ImgRif
		End Get
		Set (byval value as string)
	...
	Public Overridable Property IsLastra() as integer  Implements _IFormatoProdottoW.IsLastra
		Get
			Return _IsLastra
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property IsRotolo() as integer  Implements _IFormatoProdottoW.IsRotolo
		Get
			Return _IsRotolo
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property Larghezza() as integer  Implements _IFormatoProdottoW.Larghezza
		Get
			Return _Larghezza
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property Lunghezza() as integer  Implements _IFormatoProdottoW.Lunghezza
		Get
			Return _Lunghezza
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property NomeAlbero() as string  Implements _IFormatoProdottoW.NomeAlbero
		Get
			Return _NomeAlbero
		End Get
		Set (byval value as string)
	...
	Public Overridable Property numfacc() as integer  Implements _IFormatoProdottoW.numfacc
		Get
			Return _numfacc
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property Orientabile() as integer  Implements _IFormatoProdottoW.Orientabile
		Get
			Return _Orientabile
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property Orientamento() as integer  Implements _IFormatoProdottoW.Orientamento
		Get
	...
	Public Overridable Property PdfTemplate() as string  Implements _IFormatoProdottoW.PdfTemplate
		Get
			Return _PdfTemplate
		End Get
		Set (byval value as string)
	...
	Public Overridable Property PdfTemplate3d() as string  Implements _IFormatoProdottoW.PdfTemplate3d
		Get
	...
	Public Overridable Property ProdottoFinito() as Boolean  Implements _IFormatoProdottoW.ProdottoFinito
		Get
	...
	Public Overridable Property Sigla() as string  Implements _IFormatoProdottoW.Sigla
		Get
			Return _Sigla
		End Get
		Set (byval value as string)
...
#Region "Method"
	''' <summary>
	'''This method read an FormatoProdottoW from DB.
	''' </summary>
	''' <returns>
	...
	Public Overridable Function Read(Id As Integer) As Integer
		...
		Try
			Using Manager
				Dim int As FormatoProdottoW = Manager.Read(Id)
	...
	''' <summary>
	'''This method save an FormatoProdottoW on DB.
	''' </summary>
	''' <returns>
...
Public Interface _IFormatoProdottoW
