...
Public MustInherit Class _MacchinarioW
	Inherits LUNA.LunaBaseClassEntity
	Implements _IMacchinarioW
	...
	Friend Overridable Sub FillFromDataRecord(myRecord As IDataRecord) Implements _IMacchinarioW.FillFromDataRecord
	...
	Private Property Manager As LUNA.ILunaBaseClassDAO(Of MacchinarioW)
		Get
			If _Mgr Is Nothing Then
				Dim _MgrType As System.Type = LUNA.LunaContext.GetMgrTypeForEntity(Me.GetType)
				If _MgrType Is Nothing Then _MgrType = GetType(MacchinariWDAO)
				_Mgr = Activator.CreateInstance(_MgrType)
			End If
			Return _Mgr
		End Get
		Set(value As LUNA.ILunaBaseClassDAO(Of MacchinarioW))
			_Mgr = value
		End Set
	End Property
...
#Region "Database Field Map"
	...
	Public Overridable Property IdMacchinario() as integer  Implements _IMacchinarioW.IdMacchinario
		Get
	...
	Public Overridable Property AlertCommesse() as integer  Implements _IMacchinarioW.AlertCommesse
		Get
	...
	Public Overridable Property AltezzaCaricoCm() as integer  Implements _IMacchinarioW.AltezzaCaricoCm
		Get
	...
	Public Overridable Property CaricoPrevistoMensile() as integer  Implements _IMacchinarioW.CaricoPrevistoMensile
		Get
	...
	Public Overridable Property CopieOra() as integer  Implements _IMacchinarioW.CopieOra
		Get
			Return _CopieOra
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property CostoMensile() as integer  Implements _IMacchinarioW.CostoMensile
		Get
	...
	Public Overridable Property CostoMinAvv() as decimal  Implements _IMacchinarioW.CostoMinAvv
		Get
			Return _CostoMinAvv
		End Get
	...
	Public Overridable Property CostoSingCopia() as decimal  Implements _IMacchinarioW.CostoSingCopia
		Get
	...
	Public Overridable Property Descrizione() as string  Implements _IMacchinarioW.Descrizione
		Get
			Return _Descrizione
		End Get
	...
	Public Overridable Property DescrizioneEstesa() as string  Implements _IMacchinarioW.DescrizioneEstesa
		Get
	...
	Public Overridable Property DescrizioneOnline() as string  Implements _IMacchinarioW.DescrizioneOnline
		Get
	...
	Public Overridable Property HotFolderFlusso() as string  Implements _IMacchinarioW.HotFolderFlusso
		Get
	...
	Public Overridable Property IdRepartoDefault() as integer  Implements _IMacchinarioW.IdRepartoDefault
		Get
	...
	Public Overridable Property ImgBig() as string  Implements _IMacchinarioW.ImgBig
		Get
			Return _ImgBig
		End Get
		Set (byval value as string)
	...
	Public Overridable Property ImgRif() as string  Implements _IMacchinarioW.ImgRif
		Get
			Return _ImgRif
		End Get
		Set (byval value as string)
	...
	Public Overridable Property MinutiAvv() as integer  Implements _IMacchinarioW.MinutiAvv
		Get
			Return _MinutiAvv
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property Ordinamento() as integer  Implements _IMacchinarioW.Ordinamento
		Get
			Return _Ordinamento
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property Tipo() as integer  Implements _IMacchinarioW.Tipo
		Get
			Return _Tipo
		End Get
		Set (byval value as integer)
	...
	Public Overridable Property VisibileOnline() as integer  Implements _IMacchinarioW.VisibileOnline
		Get
...
#Region "Method"
	''' <summary>
	'''This method read an MacchinarioW from DB.
	''' </summary>
	''' <returns>
	...
	Public Overridable Function Read(Id As Integer) As Integer
		...
		Try
			Using Manager
				Dim int As MacchinarioW = Manager.Read(Id)
	...
	''' <summary>
	'''This method save an MacchinarioW on DB.
	''' </summary>
	''' <returns>
...
Public Interface _IMacchinarioW
