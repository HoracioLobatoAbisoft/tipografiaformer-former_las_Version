...
''' <summary>
'''This class manage persistency on db of ListinoBaseW object
''' </summary>
''' <remarks>
'''
''' </remarks>

Public MustInherit Class _ListinoBaseWDAO
	Inherits LUNA.LunaBaseClassDAO(Of ListinoBaseW)
	...
	''' </summary>
	''' <returns>
	'''Return a ListinoBaseW object
	''' </returns>
	Public Overrides Function Read(Id as integer) as ListinoBaseW
		Dim cls as new ListinoBaseW
	...
	''' </returns>
	Public Overrides Function Save(byRef cls as ListinoBaseW) as Integer
	...
	''' </summary>
	Public Overrides Sub Delete(byref obj as ListinoBaseW, Optional ByRef ListaObj as List (of ListinoBaseW) = Nothing)
		DestroyPermanently (obj.IdListinoBase)
		If Not ListaObj Is Nothing Then ListaObj.Remove(obj)
 
	End Sub

	Private Function InternalFind(ByVal OrderBy As String, ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) As ListinoBaseW
		Dim ris As ListinoBaseW = Nothing
		Dim So As New LUNA.LunaSearchOption With {.Top = 1, .OrderBy = OrderBy}
		Dim l As IEnumerable(Of ListinoBaseW) = FindReal(So, Parameter)
		If l.Count Then
			ris = l(0)
		End If
		Return ris
	...
	''' </summary>
	''' <returns>
	'''Return first of ListinoBaseW
	''' </returns>
	Public Overrides Function Find(ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) As ListinoBaseW
	...
	Public Overloads Function Find(ByVal OrderBy As String, ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) As ListinoBaseW
		Return InternalFind(OrderBy, Parameter)
	End Function
		
	''' <summary>
	'''Find one on DB table ListinoBaseW
	''' </summary>
	''' <returns>
	'''Return first of ListinoBaseW
	''' </returns>
	Public Overloads Function Find(ByVal OrderBy As LUNA.LunaFieldName, ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) As ListinoBaseW
	...
	''' </summary>
	''' <returns>
	'''Return a list of ListinoBaseW
	''' </returns>
	Public Overrides Function FindAll(ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) as IEnumerable(Of ListinoBaseW)
	...
	''' </returns>
	<Obsolete("Use Instead Constructor with LFM field definition")>
	Public Overloads Function FindAll(ByVal OrderBy As String, ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) as IEnumerable(Of ListinoBaseW)
	...
	''' </returns>
	<Obsolete("Use Instead Constructor with LFM field definition")>
	Public Overloads Function FindAll(byVal Top as integer, ByVal OrderBy As String, ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) as IEnumerable(Of ListinoBaseW)
	...
	'''Return a list of ListinoBaseW
	''' </returns>
	Public Overloads Function FindAll(ByVal OrderBy As Luna.LunaFieldName, ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) as IEnumerable(Of ListinoBaseW)
	...
	'''Return a list of ListinoBaseW
	''' </returns>
	Public Overloads Function FindAll(byVal Top as integer, ByVal OrderBy As Luna.LunaFieldName, ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) as IEnumerable(Of ListinoBaseW)
	...
	'''Return a list of ListinoBaseW
	''' </returns>
	Public Overloads Function FindAll(ByVal SearchOption As LUNA.LunaSearchOption, ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) As IEnumerable(Of ListinoBaseW)
	...
	''' </summary>
	''' <returns>
	'''Return a list of ListinoBaseW by custom query
	''' </returns>
	Public Function GetBySQL(SQlQuery As String, Optional AddEmptyItem As Boolean = False) As IEnumerable(Of ListinoBaseW)
	...
	Private Function FindReal(ByVal SearchOption As LUNA.LunaSearchOption, ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) as iEnumerable(Of ListinoBaseW)
		Dim Ls As New List(Of ListinoBaseW)
		Try
			Dim sql As String = ""
			sql ="SELECT "   
	...
	''' </summary>
	''' <returns>
	'''Return all record in list of ListinoBaseW
	''' </returns>
	Public Overloads Function GetAll() As IEnumerable(Of ListinoBaseW)
	...
	'''Return all record in list of ListinoBaseW
	''' </returns>
	Public Overloads Function GetAll(Optional OrderByField As LUNA.LunaFieldName = Nothing, Optional ByVal AddEmptyItem As Boolean = False) As IEnumerable(Of ListinoBaseW)
	...
	''' </returns>
	<Obsolete("Use Instead Constructor with LFM field definition")>
	Public Overrides Function GetAll(Optional OrderByField As String = "",Optional ByVal AddEmptyItem As Boolean = False) As IEnumerable(Of ListinoBaseW)
		Return InternalGetAll(OrderByField, AddEmptyItem)
	End Function

	Private Function InternalGetAll(Optional OrderByField as string = "", Optional ByVal AddEmptyItem As Boolean = False) as iEnumerable(Of ListinoBaseW)
		Dim Ls As List(Of ListinoBaseW)
		Try
			Dim sql As String = ""
	...
	Protected Function GetData(sql as string, Optional ByVal AddEmptyItem As Boolean = False) as iEnumerable(Of ListinoBaseW)
		Dim Ls As New List(Of ListinoBaseW)
		Try
			Using myCommand As DbCommand = _Cn.CreateCommand
				myCommand.CommandText = sql
