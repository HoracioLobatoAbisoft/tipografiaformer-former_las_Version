...
''' <summary>
'''This class manage persistency on db of CouponW object
''' </summary>
''' <remarks>
'''
''' </remarks>

Public MustInherit Class _CouponWDAO
	Inherits LUNA.LunaBaseClassDAO(Of CouponW)
	...
	''' </summary>
	''' <returns>
	'''Return a CouponW object
	''' </returns>
	Public Overrides Function Read(Id as integer) as CouponW
		Dim cls as new CouponW
	...
	''' </returns>
	Public Overrides Function Save(byRef cls as CouponW) as Integer
				...
				Using myCommand As DbCommand = _Cn.CreateCommand()
					Try
						...
						Else
							...
							If cls.WhatIsChanged.IdCouponInt Then sql &= "IdCouponInt = @IdCouponInt,"
						...
						If cls.WhatIsChanged.IdCouponInt Then 
							p = myCommand.CreateParameter
							p.ParameterName = "@IdCouponInt"
							p.Value = cls.IdCouponInt
							myCommand.Parameters.Add(p)
						End If
	...
	''' </summary>
	Public Overrides Sub Delete(byref obj as CouponW, Optional ByRef ListaObj as List (of CouponW) = Nothing)
		DestroyPermanently (obj.IdCoupon)
		If Not ListaObj Is Nothing Then ListaObj.Remove(obj)
 
	End Sub

	Private Function InternalFind(ByVal OrderBy As String, ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) As CouponW
		Dim ris As CouponW = Nothing
		Dim So As New LUNA.LunaSearchOption With {.Top = 1, .OrderBy = OrderBy}
		Dim l As IEnumerable(Of CouponW) = FindReal(So, Parameter)
		If l.Count Then
			ris = l(0)
		End If
		Return ris
	...
	''' </summary>
	''' <returns>
	'''Return first of CouponW
	''' </returns>
	Public Overrides Function Find(ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) As CouponW
	...
	Public Overloads Function Find(ByVal OrderBy As String, ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) As CouponW
		Return InternalFind(OrderBy, Parameter)
	End Function
		
	''' <summary>
	'''Find one on DB table CouponW
	''' </summary>
	''' <returns>
	'''Return first of CouponW
	''' </returns>
	Public Overloads Function Find(ByVal OrderBy As LUNA.LunaFieldName, ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) As CouponW
	...
	''' </summary>
	''' <returns>
	'''Return a list of CouponW
	''' </returns>
	Public Overrides Function FindAll(ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) as IEnumerable(Of CouponW)
	...
	''' </returns>
	<Obsolete("Use Instead Constructor with LFM field definition")>
	Public Overloads Function FindAll(ByVal OrderBy As String, ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) as IEnumerable(Of CouponW)
	...
	''' </returns>
	<Obsolete("Use Instead Constructor with LFM field definition")>
	Public Overloads Function FindAll(byVal Top as integer, ByVal OrderBy As String, ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) as IEnumerable(Of CouponW)
	...
	'''Return a list of CouponW
	''' </returns>
	Public Overloads Function FindAll(ByVal OrderBy As Luna.LunaFieldName, ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) as IEnumerable(Of CouponW)
	...
	'''Return a list of CouponW
	''' </returns>
	Public Overloads Function FindAll(byVal Top as integer, ByVal OrderBy As Luna.LunaFieldName, ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) as IEnumerable(Of CouponW)
	...
	'''Return a list of CouponW
	''' </returns>
	Public Overloads Function FindAll(ByVal SearchOption As LUNA.LunaSearchOption, ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) As IEnumerable(Of CouponW)
	...
	''' </summary>
	''' <returns>
	'''Return a list of CouponW by custom query
	''' </returns>
	Public Function GetBySQL(SQlQuery As String, Optional AddEmptyItem As Boolean = False) As IEnumerable(Of CouponW)
		Dim Ls As New List(Of CouponW)
		Try
	...
	Private Function FindReal(ByVal SearchOption As LUNA.LunaSearchOption, ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) as iEnumerable(Of CouponW)
		Dim Ls As New List(Of CouponW)
		Try
			Dim sql As String = ""
			sql ="SELECT "   
	...
	''' </summary>
	''' <returns>
	'''Return all record in list of CouponW
	''' </returns>
	Public Overloads Function GetAll() As IEnumerable(Of CouponW)
	...
	'''Return all record in list of CouponW
	''' </returns>
	Public Overloads Function GetAll(Optional OrderByField As LUNA.LunaFieldName = Nothing, Optional ByVal AddEmptyItem As Boolean = False) As IEnumerable(Of CouponW)
	...
	''' </returns>
	<Obsolete("Use Instead Constructor with LFM field definition")>
	Public Overrides Function GetAll(Optional OrderByField As String = "",Optional ByVal AddEmptyItem As Boolean = False) As IEnumerable(Of CouponW)
		Return InternalGetAll(OrderByField, AddEmptyItem)
	End Function

	Private Function InternalGetAll(Optional OrderByField as string = "", Optional ByVal AddEmptyItem As Boolean = False) as iEnumerable(Of CouponW)
		Dim Ls As List(Of CouponW)
		Try
			Dim sql As String = ""
	...
	Protected Function GetData(sql as string, Optional ByVal AddEmptyItem As Boolean = False) as iEnumerable(Of CouponW)
		Dim Ls As New List(Of CouponW)
		Try
			Using myCommand As DbCommand = _Cn.CreateCommand
				myCommand.CommandText = sql
				If Not LUNA.LunaContext.TransactionBox Is Nothing Then myCommand.Transaction = LUNA.LunaContext.TransactionBox.Transaction
				Using myReader As DbDataReader = myCommand.ExecuteReader()
					If AddEmptyItem Then Ls.Add(New  CouponW() With {.IdCoupon = 0 ,.Codice = "" ,.DataFineValidita = Nothing ,.DataInizioValidita = Nothing ,.IdCouponInt = 0 ,.IdLavoro = 0 ,.IdListinoBase = 0 ,.IdReview = 0 ,.ImgOnline = "" ,.ImportoFisso = 0 ,.ImportoMinimoSpesa = 0 ,.MaxVolte = 0 ,.Nome = "" ,.Percentuale = 0 ,.QtaSpecifica = 0 ,.Riservato = 0 ,.RiservatoATipoUtente = 0 ,.Stato = 0 ,.UrlHref = "" ,.VisibileOnline = 0  })
					While myReader.Read
						Dim classe as new CouponW(CType(myReader, IDataRecord))
						Ls.Add(classe)
					End While
					myReader.Close()
				End Using
