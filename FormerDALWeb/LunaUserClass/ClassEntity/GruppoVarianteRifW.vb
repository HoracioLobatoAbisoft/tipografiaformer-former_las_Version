...
Public Class GruppoVarianteRifW
	Inherits _GruppoVarianteRifW
	Implements IGruppoVarianteRifW
...
#Region "Method"
	...
	Public Overrides Function IsValid() As Boolean Implements IGruppoVarianteRifW.IsValid
	...
	Public Overrides Function Read(Id As Integer) As Integer Implements IGruppoVarianteRifW.Read
		Dim Ris as integer = MyBase.Read(Id)
		Return Ris
	End Function

	Public Overrides Function Save() As Integer Implements IGruppoVarianteRifW.Save
...
Public Interface IGruppoVarianteRifW
	Inherits _IGruppoVarianteRifW
