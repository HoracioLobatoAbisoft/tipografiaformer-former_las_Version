...
Public Class CorriereW
    Inherits _CorriereW
    Implements ICorriereW
    Implements ICorriereBusiness
...
#Region "Logic Field"
    Public ReadOnly Property Riassunto() As String
        Get
            Return StrConv(Descrizione, vbProperCase)
        End Get
    End Property
    ...
    Public ReadOnly Property LabelDataConsegna As String Implements ICorriereBusiness.LabelDataConsegna
        Get
            ...
            If TipoCorriere = enTipoCorriere.Gratis Then
                Ris = " in cui vuoi ritirare il prodotto"
            ElseIf TipoCorriere = enTipoCorriere.ConTariffa Then
                Ris = " in cui vuoi ricevere il prodotto"
            ElseIf TipoCorriere = enTipoCorriere.PortoAssegnato Then
                Ris = " in cui il tuo corriere ritirerà il prodotto"
            End If
            Return Ris
    ...
    Public ReadOnly Property NomePulito As String
        Get
            Dim NomeCorriere As String = Descrizione
    ...
    Public Function LavoraCap(Cap As String) As Boolean Implements ICorriereBusiness.LavoraCap
        ...
        Using mgr As New CapCorriereWDAO
            Dim capF As CapCorriereW = mgr.Find(New LUNA.LunaSearchParameter("IdCorriere", IdCorriere), _
    ...
    Public ReadOnly Property MetodoDiConsegna As MetodoConsegna
        Get
            Return MgrMetodiConsegna.GetMetodoConsegna(Me)
...
#Region "Method"
    ...
    Public Overrides Function IsValid() As Boolean Implements ICorriereW.IsValid
    ...
    Public Overrides Function Read(Id As Integer) As Integer Implements ICorriereW.Read
        Dim Ris As Integer = MyBase.Read(Id)
        Return Ris
    End Function

    Public Overrides Function Save() As Integer Implements ICorriereW.Save
...
Public Interface ICorriereW
    Inherits _ICorriereW
