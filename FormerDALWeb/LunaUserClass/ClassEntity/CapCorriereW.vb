...
Public Class CapCorriereW
	Inherits _CapCorriereW
    Implements ICapCorriereW
...
Public Overrides Function IsValid() As Boolean Implements ICapCorriereW.IsValid
...
Public Overrides Function Read(Id As Integer) As Integer Implements ICapCorriereW.Read
	Dim Ris as integer = MyBase.Read(Id)
    Return Ris
End Function

Public Overrides Function Save() As Integer Implements ICapCorriereW.Save
...
Public Interface ICapCorriereW
        Inherits _ICapCorriereW
