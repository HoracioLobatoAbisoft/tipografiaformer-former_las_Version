...
Public Overrides Function IsValid() As Boolean Implements IResaW.IsValid
...
Public Overrides Function Read(Id As Integer) As Integer Implements IResaW.Read
	Dim Ris as integer = MyBase.Read(Id)
    Return Ris
End Function

Public Overrides Function Save() As Integer Implements IResaW.Save
