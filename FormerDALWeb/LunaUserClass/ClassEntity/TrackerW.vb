...
#Region "Method"
	...
	Public Overrides Function IsValid() As Boolean Implements ITrackerW.IsValid
	...
	Public Overrides Function Read(Id As Integer) As Integer Implements ITrackerW.Read
		Dim Ris as integer = MyBase.Read(Id)
		Return Ris
	End Function

	Public Overrides Function Save() As Integer Implements ITrackerW.Save
