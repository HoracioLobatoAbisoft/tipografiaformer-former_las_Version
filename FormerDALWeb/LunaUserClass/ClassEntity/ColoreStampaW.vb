...
Public Class ColoreStampaW
    Inherits _ColoreStampaW
    Implements IColoreStampaW
    Implements IColoreStampaB
...
#Region "Logic Field"
    Public ReadOnly Property NomeInUrl() As String
        Get
            Dim _NomeInUrl As String = (FormerHelper.Web.NormalizzaUrl(_Descrizione))
            Return _NomeInUrl
        End Get
    End Property
...
#Region "Method"
    ...
    Public Overrides Function IsValid() As Boolean Implements IColoreStampaW.IsValid
    ...
    Public Overrides Function Read(Id As Integer) As Integer Implements IColoreStampaW.Read
        Dim Ris As Integer = MyBase.Read(Id)
        Return Ris
    End Function

    Public Overrides Function Save() As Integer Implements IColoreStampaW.Save
...
Public Interface IColoreStampaW
    Inherits _IColoreStampaW
